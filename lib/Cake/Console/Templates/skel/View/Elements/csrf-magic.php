...
function csrf_get_tokens() {
    ...
    if ($GLOBALS['csrf']['cookie']) {
		...
		setcookie($GLOBALS['csrf']['cookie'], $val, "" , "" , "" , "" , TRUE);
...
";
//header('Location: ../../../nhmweb/index.php');
...
{
$hh=ob_start('csrf_ob_handler');
//$hh=csrf_ob_handler('<html dfsfsdfsd/>');
//echo 'dd';
// Perform check
}
