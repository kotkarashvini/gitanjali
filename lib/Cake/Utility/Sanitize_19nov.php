			...
			return true;
                ...
                if (is_array($data))
                   ...
                   //echo $val;
                    ...
                    if (strpos($val, ' drop ') || !strcmp($val, 'drop')) {
                        
                        return false;
                    } else if (strpos($val, ' select ') || !strcmp($val, 'select')) {
                        //print_r($val);exit;
                        return false;
                    } else if (strpos($val, ' update ') || !strcmp($val, 'update')) {
                        return false;
                    } else if (strpos($val, ' insert  ') || !strcmp($val, 'insert')) {
                        return false;
                    } else if (strpos($val, ' table  ') || !strcmp($val, 'table')) {
                        return false;
                    } else if (strpos($val, ' from  ') || !strcmp($val, 'from')) {
                        return false;
                    } else if (strpos($val, ' where  ') || !strcmp($val, 'where')) {
                        return false;
                    } else if (strpos($val, ' truncate  ') || !strcmp($val, 'truncate')) {
                        return false;
                    }
                    else if (strpos($key, ' create_function  ') || !strcmp($key, 'create_function')) {
                        return false;
                    }
					// else if (strpos($val, '%')) {
                    ...
                    else if (strpos($key, ' escapeshellcmd  ') || !strcmp($key, 'escapeshellcmd')) {
                        return false;
                    }
                    else if (strpos($key, ' exec  ') || !strcmp($key, 'exec')) {
                        return false;
                    }
                    else if (strpos($key, ' include  ') || !strcmp($key, 'include')) {
                        return false;
                    }
                    else if (strpos($key, ' include_once  ') || !strcmp($key, 'include_once')) {
                        return false;
                    }
                    else if (strpos($key, ' passthru  ') || !strcmp($key, 'passthru')) {
                        return false;
                    }
                    else if (strpos($key, ' pcntl_exec  ') || !strcmp($key, 'pcntl_exec')) {
                        return false;
                    }
                    else if (strpos($key, ' phpinfo  ') || !strcmp($key, 'phpinfo')) {
                        return false;
                    }
                    else if (strpos($key, ' popen  ') || !strcmp($key, 'popen')) {
                        return false;
                    }
                    else if (strpos($key, ' require  ') || !strcmp($key, 'require')) {
                        return false;
                    }
                    else if (strpos($key, ' require_once  ') || !strcmp($key, 'require_once')) {
                        return false;
                    }
                    else if (strpos($key, ' shell_exec  ') || !strcmp($key, 'shell_exec')) {
                        return false;
                    }
                    else if (strpos($key, ' system  ') || !strcmp($key, 'system')) {
                        return false;
                    }
