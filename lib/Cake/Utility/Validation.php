 ...
 */
	...
	public static function test($check) {
		if (is_array($check)) {
			extract(self::_defaults($check));
		}
...
/***check Alphabets String ***************/
        
        public static function isAlphString($check,$lenght) {
	    $len=strlen($check);
		 $checkstring=(string)$check;
		 $string=strtolower(trim($checkstring));
		...
		else if(strpos($string,' drop ') || !strcmp($string,'drop'))
		{
			return false;
		}
		else if(strpos($string,' select ') || !strcmp($string,'select'))
		{
			return false;
		}
		else if(strpos($string,' update ') || !strcmp($string,'update'))
		{
			return false;
		}
		else if(strpos($string,' insert  ') || !strcmp($string,'insert'))
		{
			return false;
		}
		else if(strpos($string,' table  ') || !strcmp($string,'table'))
		{
			return false;
		}
		else if(strpos($string,' from  ') || !strcmp($string,'from'))
		{
			return false;
		}
		else if(strpos($string,' where  ') || !strcmp($string,'where'))
		{
			return false;
		}
		else if(strpos($string,' truncate  ') || !strcmp($string,'truncate'))
		{
			return false;
		}
		return self::_check($check, $regex);
	}
        /********end Alphabets string *********/
         /********Start Alphanumeric string *********/
         public static function isAlfaNumericString($check,$lenght) {
		...
		return self::_check($check, $regex);
         ...
         public static function isAlfaNumericdotString($check,$lenght) {
        ...
        public static function isNumeric($check,$length) {
             $checkstring=(string)$check;
                 $len=strlen($checkstring);
                 if($len!=$length)
                 {
        ...
        public static function isPassword($check,$lenght) {
