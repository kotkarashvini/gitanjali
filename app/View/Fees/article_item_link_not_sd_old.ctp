    ...
    <div class="col-lg-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <a  href="<?php echo $this->webroot;?>helpfiles/admin/article_item_link_not_sd_<?php echo $lang; ?>.html" class="btn btn-default pull-right " target="_blank"> <?php echo  __('help');?> <span class="fa fa-question fa-circle-o"></span></a>
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="form-group">
                        <label for="Select Article" class="control-label col-sm-2" ><?php echo __('lblArticle'); ?></label>   
                        <div class="col-sm-6">  <?php echo $this->Form->input('article_id', array('type' => 'select', 'empty' => '--select--', 'options' => $articlelist, 'label' => false, 'multiple' => false, 'id' => 'article_id', 'class' => 'form-control input-sm')); ?> </div>
                    </div>
                </div>
                <div  class="rowht">&nbsp;</div>
                <div class="row">
                    <div class="form-group">                           
                        ...
                        <div class="col-sm-6" style="height:25vh;overflow-y: scroll; border: 2px #00529B ridge;padding-left: 3%; "> 
                            <?php echo $this->Form->input('fee_item_id', array('type' => 'select', 'options' => $inputitemlist, 'label' => false, 'multiple' => 'checkbox', 'id' => 'dpendtattrlist')); ?>
                        </div> 
                    </div>
                </div>
                <div  class="rowht">&nbsp;</div>
