...
//                        window.location.reload(true);
    ...
    function formupdate(fee_item_id, list_item_value,
<?php
    ...
    <div class="col-lg-12">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="form-group">
                        <label for="rule_desc_en" class="col-sm-3 control-label"><?php echo __('lblitem') . ' ' . __('lblid'); ?><span style="color: #ff0000">*</span></label>
...
//  creating dyanamic table header using same array of config language
                            ...
                            <td style="text-align: center; width: 10%;"><?php echo __('lblitem') . ' ' . __('lblid'); ?></td>
                        ...
                        <?php foreach ($feeitemlistrecord as $feeitemlistrecord1): ?>
                            <tr id="<?php echo $feeitemlistrecord1['article_fee_item_list']['fee_item_list_id']; ?>">
                                ...
                                <td style="text-align: center;">
                                    <button id="btnupdate" name="btnupdate" type="button" data-toggle="tooltip" title="Edit" class="btn btn-default " style="text-align: center;"  onclick="javascript: return formupdate(('<?php echo $feeitemlistrecord1['article_fee_item_list']['fee_item_id']; ?>'), ('<?php echo $feeitemlistrecord1['article_fee_item_list']['list_item_value']; ?>'),
                                    <?php
                                    ...
                                    <?php echo $this->Form->button('<span class="glyphicon glyphicon-remove"></span>', array('title' => 'Delete', 'type' => 'button', 'onclick' => "javascript: return removeListItem(" . $feeitemlistrecord1['article_fee_item_list']['fee_item_list_id'] . ", '" . (base64_encode($feeitemlistrecord1['article_fee_item_list']['fee_item_list_id'])) . "')")); ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
