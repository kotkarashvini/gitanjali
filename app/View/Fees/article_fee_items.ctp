...
//--------------------------------------------------------------------------------------------------------------------------------------
        $('.min, .max,#rounding_div,.round_value,#list_flag_div,.headcode,#online_compultion_flag_div,#sd_calc_flag,#gen_dis_flag').hide();
...
//-------------------------------------------------------------------------------------------------------------------------
    ...
    function param_type_change(param_type_id, min_value, max_value) {
        (param_type_id == 2 || param_type_id == 6) ? ($('.min,.max,#rounding_div,.headcode,.fee_type').show(), $('#list_flag_div,#sd_calc_flag,#gen_dis_flag').hide(), $('input:radio[name="data[fees_items][list_flag]"][value=N]').prop('checked', true)) : ($('.min,.max,#rounding_div,.headcode,.fee_type').hide(), $('#list_flag_div,#sd_calc_flag,#gen_dis_flag').show());
...
//    function formupdate(id, fee_item_desc_en, fee_param_type_id, fee_type_id, fee_item_desc_ll, fee_item_desc_ll1, fee_item_desc_ll2, fee_item_desc_ll3, fee_item_desc_ll4) {
    function formupdate(id, fee_item_desc_en, fee_param_type_id, fee_type_id, o_compultion_flag, account_head_code, fee_item_desc_ll, fee_item_desc_ll1, fee_item_desc_ll2, fee_item_desc_ll3, fee_item_desc_ll4, min_value, max_value, round_flag, round_id, list_flag,sd_calc_flag,gen_dis_flag) {
...
// (fee_param_type_id == 1 || fee_param_type_id == 5) ? ($('#list_flag_div,#sd_calc_flag,#gen_dis_flag').show()) : ($('#list_flag_div,#sd_calc_flag,#gen_dis_flag').hide());
        ...
        $('#rounding_id').val(round_id);
         (fee_param_type_id == 1 || fee_param_type_id == 5) ? ($('#sd_calc_flag,#gen_dis_flag').show()) : ($('#sd_calc_flag,#gen_dis_flag').hide());
//        $('#sd_calc_flag').val(sd_calc_flag);
//         $('#gen_dis_flag').val(gen_dis_flag);
          $('input:radio[name="data[fees_items][sd_calc_flag]"][value=' + sd_calc_flag + ']').prop('checked', true);
           $('input:radio[name="data[fees_items][gen_dis_flag]"][value=' + gen_dis_flag + ']').prop('checked', true);
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <?php 
                             $itemtype=  array('1'=>__('lblfeeinput'),'2'=>__('lblfeeoutput'));
                            echo $this->Form->input('fee_param_type_id', array('label' => false, 'id' => 'fee_param_type_id', 'class' => 'form-control input-sm', 'options' => array($itemtype), 'empty' => '--Select--')); ?>
                        ...
                        <div class="row fee_type">
                            ...
                            <div class="col-sm-2"><?php echo $this->Form->input('fee_type_id', array('label' => false, 'id' => 'fee_type_id', 'class' => 'form-control input-sm fee_type', 'options' => $feetype)); ?>
                                <!--<span id="fee_param_type_id_error" class="form-error"><?php //echo $errarr['fee_param_type_id_error'];  ?></span>-->
                            </div>
                        </div>
                        ...
                        <div class="row" id="list_flag_div">
                         ...
                         <div class="row" id="sd_calc_flag">
                             
                             <div class="col-sm-12">
                                 <label for="sd_calc_flag"  class="col-sm-2 control-label"><?php echo __('lblsdscreen'); ?></label>    
                            <div class="form-group">
                                <?php //echo $this->Form->input('sd_calc_flag', array('label' => false, 'id' => 'sd_calc_flag', 'class' => 'form-control input-sm fee_type', 'options' => $sdcalcflag)); ?>
                                 <div class="col-sm-4"><?php echo $this->Form->input('sd_calc_flag', array('type' => 'radio', 'options' => array('Y' => '&nbsp;Yes&nbsp;&nbsp;&nbsp;&nbsp;', 'N' => '&nbsp;No'), 'value' => 'Y', 'legend' => false, 'div' => false, 'class' => 'select', 'id' => 'sd_calc_flag')); ?></div> 
                                <!--<span id="fee_param_type_id_error" class="form-error"><?php //echo $errarr['fee_param_type_id_error'];  ?></span>-->
                            </div></div></div>
                           
                       <div class="row" id="gen_dis_flag">
                           <div class="col-sm-12">
                            <label for="gen_dis_flag"  class="col-sm-2 control-label"><?php echo  __('lblgdscreen'); ?></label>    
                            <div class="form-group">
                               
                             <div class="col-sm-4"><?php echo $this->Form->input('gen_dis_flag', array('type' => 'radio', 'options' => array('Y' => '&nbsp;Yes&nbsp;&nbsp;&nbsp;&nbsp;', 'N' => '&nbsp;No'), 'value' => 'N', 'legend' => false, 'div' => false, 'class' => 'select', 'id' => 'gen_dis_flag')); ?></div> 
                                <!--<span id="fee_param_type_id_error" class="form-error"><?php //echo $errarr['fee_param_type_id_error'];  ?></span>-->
                            </div>
                        </div> </div>
                        

                        <label for="min Value"  class="min col-sm-2 control-label"><?php echo __('lblMinValue'); ?></label>    
                        ...
                        <label for="max Value"  class="max col-sm-2 control-label"><?php echo __('lblmaxval'); ?></label>    
                ...
                <div class="row" id="rounding_div">
                    <div class="form-group">
                        <label for="fee_rounding_flag"  class="col-sm-2 control-label"><?php echo __('lblfeeroundingflag'); ?></label>    
                        <div class="col-sm-2"><?php echo $this->Form->input('fee_rounding_flag', array('type' => 'radio', 'options' => array('Y' => '&nbsp;Yes&nbsp;&nbsp;&nbsp;&nbsp;', 'N' => '&nbsp;No'), 'value' => 'N', 'legend' => false, 'div' => false, 'class' => 'select', 'id' => 'fee_rounding_flag')); ?></div>
...
<!--                            <span id="rounding_id_error" class="form-error"><?php //echo $errarr['rounding_id_error']; ?></span>-->
                        </div>
                    </div>
                </div>    
            ...
            <div class="row">
                <div class="form-group center">
                    <button id="btnadd" type="submit" name="btnadd" class="btn btn-info "    onclick="javascript: return formadd();">
                        <?php echo __('btnsave'); ?></button> &nbsp;&nbsp;
                     <a href="<?php echo $this->webroot; ?>Fees/article_fee_items" class="btn btn-info "><?php echo __('btncancel'); ?></a>
                </div>
            </div>
        </div>
                    ...
                    <table id="tablefees_items" class="table table-striped table-bordered table-hover">  
                        <thead >  
                            <tr>  
                                ...
                                <th class="center"><?php echo __('lblsdscreen'); ?></th>
                                <th class="center"><?php echo __('lblgdscreen'); ?></th>
                        ...
                        <?php for ($i = 0; $i < count($fees_items); $i++) { ?>
                            <tr id="<?php echo $fees_items[$i][0]['fee_item_id']; ?>">
                                ...
                                <td ><?php echo $fees_items[$i][0]['sd_calc_flag']; ?></td>
                                 <td ><?php echo $fees_items[$i][0]['gen_dis_flag']; ?></td>
                                <td >
                                    <button id="btnupdate" name="btnupdate" class="btn-sm btn-success "  onclick="javascript: return formupdate(
                                                    ...
                                                    ('<?php echo $fees_items[$i][0]['list_flag']; ?>'),
                                                     ('<?php echo $fees_items[$i][0]['sd_calc_flag']; ?>'),
                                                     ('<?php echo $fees_items[$i][0]['gen_dis_flag']; ?>')
                                                    );">
                                        <span class= "fa fa-pencil"></span>
                                    </button>
                                    
                                    <?php echo $this->Html->Link($this->Html->tag('span', '', array('class' => 'fa fa-remove')), array('action' => 'remove_article_fee_item',$fees_items[$i][0]['fee_item_id']), array('escape' => false, 'data-toggle' => 'tooltip', 'title' => __('Delete'), 'class' => "btn btn-danger"), array('Are you sure to Delete?')); ?>
                                </td>
                            </tr>
                        <?php } ?>
                    </table> 
