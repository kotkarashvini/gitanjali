                    ...
                    <div class = 'form-group'>
                        ...
                        <?php if ($feeItem['list_flag'] == 'Y') { ?>
                            ...
                            <div class = 'col-sm-3' style = 'background-color:#aab2b2;'>
                                ...
                                <?php echo $this->Form->input($feeItem['fee_param_code'], array('type' => 'select', 'id' => $feeItem['fee_param_code'], 'label' => FALSE, 'value' => 0, 'options' => (($items_list[$feeItem['fee_param_code']]) ? $items_list[$feeItem['fee_param_code']] : NULL))); ?>
                        ...
                        <?php } else {
                            ...
                            if ($exmption == 'Y') {
                                ...
                                <div class = 'col-sm-3'>
                                    ...
                                    <?php echo $this->Form->input($feeItem['fee_param_code'], array('label' => FALSE, 'type' => $type, 'id' => $feeItem['fee_param_code'], 'value' => 0, 'maxlength' => 15)); ?> 
                                    <span id="<?php echo $feeItem['fee_param_code']; ?>_error" class="form-error"> </span>
                            ...
                            <?php } else { ?> 
                                ...
                                <div class = 'col-sm-3'>
                                    ...
                                    if ($feeItem['fee_param_code'] == 'FAA') {
                                        echo $this->Form->input($feeItem['fee_param_code'], array('label' => FALSE, 'type' => $type, 'id' => $feeItem['fee_param_code'], 'value' => 0, 'maxlength' => 15, 'readonly' => 'readonly'));
                                    ...
                                    } else if ($feeItem['fee_param_code'] == 'FCY') { //FCY=Party Shares
                    ...
                    <div class = 'col-sm-12'>
                        <div class = 'form-group'>
                            ...
                            <div class = 'col-sm-3' style = 'background-color:#aab2b2;'>
                                ...
                                <?php
                                echo $this->Form->input($feeItem['fee_param_code'], array('type' => 'select', 'id' => $feeItem['fee_param_code'], 'disabled', 'style' => 'cursor: not-allowed;', 'label' => FALSE, 'value' =>0, 'options' => (($items_list[$feeItem['fee_param_code']]) ? $items_list[$feeItem['fee_param_code']] : NULL)));
                                echo $this->Form->input($feeItem['fee_param_code'], array('label' => FALSE, 'type' => 'hidden', 'id' => $feeItem['fee_param_code'], 'value' => 0, 'maxlength' => 15));
                                ?>
