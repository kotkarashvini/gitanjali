...
echo $this->Form->create('propertyscreennew', array('url' => array('controller' => 'citizenentry', 'action' => 'property_details'), 'id' => 'propertyscreennew'));
                            ...
                            <?php foreach ($property_list as $key => $property) { ?>
                                <tr>
                                    ...
                                    <td class="tblbigdata">
                                        ...
                                        <?php
                                        echo $this->Html->link('PDF', array('class' => '', 'controller' => 'Reports', 'action' => 'rptview', 'P', $property[0]['val_id']), array('class' => 'btn btn-info'));
                                        echo $this->Html->link('Edit', array('controller' => 'citizenentry', 'action' => 'property_details', $property[0]['property_id']), array('confirm' => 'Are you sure you wish to Edit this property?', 'class' => 'btn btn-info')
                                        );

                                        echo $this->Html->link('Delete', array('controller' => 'Citizenentry', 'action' => 'property_remove', $property[0]['property_id']), array('confirm' => 'Are you sure you wish to delete this property?', 'class' => 'btn btn-info')
                                        );
                                        ?>
                                    </td>
                                </tr>
