...
//                            var SHA1Hash1 = hex_sha1(password1);
//                            var SHA1Hash2 = hex_sha1(rpassword);
                            ...
                            var SHA1Hashnewpassword = hex_sha256(newpassword);
                            //alert(SHA1Hashnewpassword);
                            //var SHA1Hashpassresult = hex_sha256(SALT + SHA1Hashnewpassword);
                            document.getElementById("newpassword").value = SHA1Hashnewpassword;

                            var SHA1Hashr_password = hex_sha256(rpassword);
                            //alert(SHA1Hashr_password);
                            //var SHA1Hashre_passresult = hex_sha256(SALT + SHA1Hashr_password);
                            document.getElementById("r_password").value = SHA1Hashr_password;
...
$('#btnotp1').click(function () {
            ...
            $.post('<?php echo $this->webroot; ?>Citizenuser/otpresetpasswordcitizen', {username: username,password:password}, function (data)
            {
               alert(data);
...
<div class="login-box"> 
    ...
    <div class="login-box-body">
        ...
        <div class="col-sm-12">
            <center>
                <label for="enterotp" class="control-label col-sm-4" id="lblotp"><?php echo __('lblenterotp'); ?></label>
                <div class="col-sm-8" style="text-align: center">
                    <?php echo $this->Form->input('otp', array('label' => false, 'id' => 'otp', 'autocomplete' => 'off','placeholder' => 'Enter OTP','value'=>$otp)); ?></div>
                <div class="col-sm-4">
