                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <div>
                                <input name="token_no" id="token_no" class="form-control" value="" />
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <select class="form-control" id="feetype" name="feetype">
                                    ...
                                    <option value="3">Certified copy Fee</option>
...
<!--                        <table class="table table-striped">
                            ...
                            <tr>
                                <td  class="text-danger">Certified copy Fee</td>  <td class="text-success1"><b><span class="fa fa-rupee"></span> 100 </b></td>
                            </tr>
...
//                                        }
                                        ...
                                        <?php if ($single['payment_status'] == 'CREATED') { ?>
                                            ...
                                            <a href="<?php echo $this->webroot; ?>GAWebService/gras_payment_entry_new_fees/<?php echo $single['gateway_trans_id']; ?>" class="btn btn-primary" >Update Status</a>
                                        <?php } else { ?>
