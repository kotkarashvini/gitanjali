...
<script type="text/javascript">
    ...
    function scanToJpg() {
        ...
        if (docid != "") {
            $.post('<?php echo $this->webroot; ?>Registration/checkscan', {path: path, docid: docid}, function (data)
            {
                if (data == 1) {
...
//                             "use_asprise_dialog": false,
                            ...
                            "output_settings": [
                                ...
                                },
                                {
                                    ...
                                    "upload_target": {
                                        "url": "http://<?php echo $_SERVER['HTTP_HOST']; ?>/NGDRS_MH/Registration/upload",
                                        "post_fields": {
                                            "docid": docid,
                                            "saveflag": saveflag,
                                            "token" : token
