            ...
            <div class="panel-heading">
                ...
                <div class="pull-right action-buttons">
                    <div class="btn-group pull-right"> 
                        <?php echo __('lbldocrno'); ?> : <?php echo $feedetails[0][0]['doc_reg_no']; ?>                      
                    </div>
                </div>
            </div>
...
//                                    pr($feedetails);exit;
                                                    ...
                                                    <td width="15%" class="bg-info">    
                                                        <div class="btn-group">                                         
                                                            ...
                                                            if ($status == 99 && $feedetails[0][0]['payment_accept_flag'] == 'N') { //and $documents[0][0][$funflag] == 'N'
                                                                ...
                                                                <a   class="btn btn-danger" href="<?php echo $this->webroot; ?>Registration/certified_copy_payment_entry/<?php echo $paydetails['payment_id']; ?>">Delete</a>
                                                            <?php } ?>
                                                        </div>   
                                                    </td>       
                                                    <?php
                        ...
                        <div class="panel-footer center"> 
                            ...
                            echo $this->Form->create('encum_cert_payment');
