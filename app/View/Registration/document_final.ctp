        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="pull-right ">
                    <?php
//                     echo $this->Html->link('Final Certificate',array('controller' => 'Reports', 'action' => 'rptcertificate_20', $token), array('id' => 'dddd', 'class' => 'btn btn-warning'));
                    ?>
...
//                        if ($state_id == 27) { ?>
                    ...
                    <?php } ?>          
                    <?php
                      if ($documents[0][0][$funflag] == 'Y' && !empty($regconf_docnofinal1)) {  
                        echo $this->Html->link(
...
//                }
                ...
                <!--<textarea> <?php //echo $summary2full;   ?></textarea>-->
            </div>
            <div class="modal-footer">
...
<!-- Registration Summary 2 Thumbbook -->
<div id="modelRegSummary11" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title"><?php echo __('Thumb Book'); ?> </h4>
            </div>
            <div class="modal-body center" id="rptRegSummary11">

                <?php echo $thumb; ?>
            </div>
            <div class="modal-footer">
                <!--<a type="button" href="<?php //echo $this->webroot;   ?>Reports/thumbbook_goa/<?php // echo base64_encode($documents[0][0]['token_no']);   ?>/D"</a>-->
                <button type="button" class="btn btn-default" id="summary1print1"><?php echo __('lblprint'); ?></button>
...
<script type='text/javascript'>
    jQuery(function ($) {
        ...
        $('#summary2fullprint').on('click', function () { // for printer header set document serial number summ2
            var t = $('title').html();
            $('title').html('<?php echo @$documents[0][0]['doc_reg_no']; ?>');
        ...
        $('#summary1print').on('click', function () { // for printer header set document serial number summ1
            vat
            t = $('title').html();
            $('title').html('<?php echo @$documents[0][0]['doc_reg_no']; ?>');
            $.print("#rptRegSummary1");
