    ...
    <div class="col-lg-12">
        <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <div class="box-tools ">
                    <a  href="<?php echo $this->webroot; ?>helpfiles/Registration/reg_sub_sub_menu.html" class="btn btn-small btn-info" target="_blank"> <i class="fa fa-info-circle"></i>  <?php echo __('Help'); ?> </a>
                ...
                <div class="row" style="text-align: center">
                    <div class="form-group">
                        <div class="col-sm-12 tdselect">
                           ...
                           <a href="<?php echo $this->webroot; ?>Registration/reg_sub_sub_menu" class="btn btn-info "><?php echo __('btncancel'); ?></a>
                            ...
                            <?php foreach ($subsubmenurecord as $subsubmenurecord1): ?>
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        ...
                                        <a <?php echo $this->Html->Link($this->Html->tag('span', '', array('class' => 'glyphicon glyphicon-remove')), array('action' => 'reg_sub_sub_menu_delete', $subsubmenurecord1['RegistrationSubsubmenu']['subsubmenu_id']), array('escape' => false, 'data-toggle' => 'tooltip', 'title' => __('Delete'), 'class' => "btn btn-danger"), array('Are you sure?')); ?></a>       
                                    </td>
                                </tr>
                            <?php endforeach; ?>
