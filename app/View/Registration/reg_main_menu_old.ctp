...
<!--                        <label for="submenuflag" class="col-sm-3 control-label"><?php echo __('lblsubmenuflag'); ?><span style="color: #ff0000">*</span></label>    
                        ...
                        <div class="form-group">
                            <div class="col-sm-12 tdselect">
                                ...
                                <button id="btnadd" name="btncancel" class="btn btn-info "  type="reset">
                                    <span class="glyphicon glyphicon-floppy-remove"></span>&nbsp; &nbsp;<?php echo __('lblreset'); ?></button>
                            </div>
                        </div>
                    </div>
         ...
         <!--<td style="text-align: center;"><?php // echo $mainmenurecord1['0']['minor_desc'];   ?></td>-->
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <a <?php echo $this->Html->Link($this->Html->tag('span', '', array('class' => 'glyphicon glyphicon-remove')), array('action' => 'reg_main_menu_delete', $mainmenurecord1['RegistrationMainmenu']['mainmenu_id']), array('escape' => false, 'data-toggle' => 'tooltip', 'title' => __('Delete'), 'class' => "btn btn-default"), array('Are you sure?')); ?></a>       
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
