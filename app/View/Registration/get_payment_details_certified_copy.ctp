...
if (isset($paymentfields) && !empty($paymentfields)) {
    ?>
<?php if($this->Session->read('type')=='C'){?>
    <?php echo $this->Form->create('payment', array('url' => array('controller' => 'Registration', 'action' => 'certified_copy_payment')), array('id' => 'payment', 'class' => 'form-vertical')); ?>   
<?php }else {?>
 
<?php echo $this->Form->create('payment', array('url' => array('controller' => 'Registration', 'action' => 'encum_cert_payment')), array('id' => 'payment', 'class' => 'form-vertical')); }?>             
