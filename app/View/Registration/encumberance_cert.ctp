                               ...
                               // pr($documents);
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-primary" href="<?php echo $this->webroot;?>Registration/encum_cert_payment/<?php echo $documents[0]['doc_reg_no']; ?>/<?php echo $documents[0]['details_id']; ?>">Select</a>
