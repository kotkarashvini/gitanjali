...
//                               exit;
                                            ?>
                                            <button type="button"  id='btncap' class="btn btn-primary" onclick="javascript: return formEkyc('<?php echo $party[0]['party_id']; ?>', '<?php echo $variables; ?>');"><?php echo 'EKYCverified'; ?></button>
            ...
            <div id="ekycmyModal" class="modal fade MyModel100" role="dialog">
...
//            });
        ...
        function authenticate() {
            ...
            $.post('<?php echo $this->webroot; ?>Registration/ekycverification', {id: id, uid: uid, capturexml: capturexml, consent: consent}, function (data)
            {
