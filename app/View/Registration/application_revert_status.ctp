...
<div id="documentrevert" class="modal fade" role="dialog">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title"><?php echo __('Revert Application Remark'); ?> </h4>
            </div>
            ...
            <div class="form-group">
                    <label><?php echo __('lblreason'); ?></label>
                        ...
                        ?>  
                    <span class="form-error" id="revertback_id_error"></span><?php // echo $errarr['revertback_id_error'];   ?></span>
                </div>
            </div>
            <div class="modal-body" >
                <div class="form-group">
...
<?php
echo $this->Form->create('application_revert_status', array('id' => 'application_revert_status', 'autocomplete' => 'off'));
?>
<div class="row">
    <div class="col-lg-12">
        <div class="box box-primary">
            <div class="box-body">
                <div class="row">
                    <div>
                        <center><h4 class = "box-title headbolder"><?php echo __('Application Revert Status'); ?></h4></center>
                    </div>
                    <div  class="rowht"></div>  <div  class="rowht"></div> 
                    <div class="col-sm-2"></div>
                    <div class="form-group" id="tokenid" >
                        <label for="tok_no" class="control-label col-sm-2"><?php echo __('Token Number'); ?><span style="color: #ff0000">*</span></label>
                        <div class="col-sm-3">
                            ...
                            <tbody>
                                ...
                                foreach ($tokengrid as $rec):
                                    ...
                                    <tr>
                                        ...
                                        <td ><button type="button" class="btn btn-info " data-toggle="modal" data-target="#documentviewsummary" onclick="javascript: return details('<?php echo $rec[0]['token_no']; ?>', 'K');"> <?php echo __('View Summary'); ?></button></td>
