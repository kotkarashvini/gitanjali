...
<script>
    $(document).ready(function () {
        ...
        $('.graph').click(function () {
            ...
            var to = $("#todate").val();
            var office_id = '<?php echo $office_id; ?>';
            $.post(fun, {from: from, to: to, office_id:office_id}, function (data)
            {   
                $("#divdashboard").html('');
...
<div class="graph col-lg-3 col-xs-6" id="accheadcol" data-toggle="modal" data-target="#myModal">
                        ...
                        <div class="small-box bg-yellow">
                            <div class="inner">
                                <h3><?php if($distcol[0][0]['pamount'] == null){$amount=0;}else{$amount=(round($distcol[0][0]['pamount'])/100000).'L';} echo $amount; ?></h3>
