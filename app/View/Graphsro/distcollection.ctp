...
<?php echo $this->Form->create('distcollection', array('id' => 'distcollection', 'autocomplete' => 'off')); ?>
<div class="row">
    <div class="col-lg-12">
            ...
            <div class="box-header with-border">
                <center>
                    <h3 class="box-title headbolder">
                        <?php echo 'District wise Collection(Collection in Lakhs)'; ?>
                    </h3>
                </center>
            </div>
...
//                    top: 50, right: 10, bottom: 50, left: 50 }
                top: 50, right: 10, bottom: 100, left: 100 }
            ,
                    width = $(chart[0])
...
//                        if(result[s]['Total']>100000){
                            result[s]['Total'] = result[s]['Total']/100000;
//                            result[s]['Total'] = Math.floor(result[s]['Total']/100000)
//                            result[s]['Total'] = result[s]['Total'] + 'L';
//                        }
...
<?php foreach ($data as $data1) {
    ?>
                ...
                District: "<?php echo $data1['district_name_en']; ?>",
                        ...
                        Total: <?php echo round($data1['total']);
    ?>,
                }
                ,
<?php }
