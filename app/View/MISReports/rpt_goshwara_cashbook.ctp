...
<?php echo $this->Form->create('rpt_goshwara_cashbook', array('id' => 'rpt_goshwara_cashbook')); ?>

<div class = "box box-primary">
    <div class = "box-header with-border">
        <center><h3 class = "box-title headbolder"> <?php echo __('lblghoshwaracashbook'); ?> </h3></center>
    </div>
    <div class="box-body">
...
<?php if ($pdf_flag) { ?>
    <iframe src="<?php echo $this->webroot ?>ghoshwara_cashbook_pdf" width="100%" height="500px">
    <?php
}
?>
