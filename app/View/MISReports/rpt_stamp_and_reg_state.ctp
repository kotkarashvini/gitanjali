...
<?php echo $this->Form->create('rpt_stamp_and_reg_state', array('id' => 'rpt_stamp_and_reg_state')); ?>

<div class = "box box-primary">
    <div class = "box-header with-border">
        <center><h3 class = "box-title headbolder">STAMP AND REGISTRATION FEES COMPARATIVE STATEMENT</h3></center>
    </div>
      <div class="box-body">
