...
<?php echo $this->Form->create('rpt_stamp_and_regfees', array('id' => 'rpt_stamp_and_regfees')); ?>

<div class = "box box-primary">
    <div class = "box-header with-border">
        <center><h3 class = "box-title headbolder">Stamp And Registration Fees</h3></center>
    </div>
      <div class="box-body">
