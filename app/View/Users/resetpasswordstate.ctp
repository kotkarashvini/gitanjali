...
<?php echo $this->Form->create('resetpasswordstate'); ?>

<div class="login-box"> 

    <div class="login-box-body">
        <a href="<?php echo $this->webroot; ?>helpfiles/Users/resetpassword<?php echo $doc_lang; ?>.html" class="btn btn-default pull-right " target="_blank"> <?php echo __('help'); ?> <span class="fa fa-question fa-circle-o"></span></a>
        ...
        <div class="form-group has-feedback">
            <div class="input-group">
                ...
                <?php echo $this->Form->input('username', array('label' => false, 'type' => 'text', 'id' => 'username', 'class' => ' form-control')); ?>
