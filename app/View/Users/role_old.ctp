            ...
            <div class="box-body">
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <?php echo $this->Form->input('role_id', array('label' => false, 'id' => 'role_id', 'class' => 'form-control input-sm', 'type' => 'text')) ?>
                        ...
                        <div class="col-sm-2">
                            <?php echo $this->Form->input('role_name', array('label' => false, 'id' => 'role_name', 'class' => 'form-control input-sm', 'type' => 'text')) ?>
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <label for="valid_for_months" class="col-sm-2 control-label"><?php echo __('lblvalidateformonths'); ?><span style="color: #ff0000">*</span></label>    
                        <div class="col-sm-2">
