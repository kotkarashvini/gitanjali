...
<!--                            <div class="col-sm-2"><?php //echo __('lblcitizentype'); ?></div>
                            ...
                            <label for="contact_person" class="col-sm-3 control-label" ><?php echo __('lblselecttype'); ?></label>  
                            <div class="col-sm-3">  <?php echo $this->Form->input('reg_type', array('label' => false, 'id' => 'reg_type', 'class' => 'form-control input-sm', 'empty' => '--Select--', 'options' => array($reg_type))); ?></div>                            
                        </div>
                    </div>
                </div>
                ...
                <div class="box box-primary">
                    <div class="box-body">
                        <div class="row" id="idbuilder">
                            <div class="form-group">
                                <label for="builder" class="col-sm-3 control-label"><?php echo __('lblbuildercmpname'); ?><span style="color: #ff0000">*</span></label>    
                                <div class="col-sm-3">
                                    <?php echo $this->Form->input('buildername', array('label' => false, 'id' => 'buildername', 'type' => 'text', 'class' => 'form-control', 'maxlength' => '100')); ?>
                                    <!--<span id="buildername_error" class="form-error"><?php //echo $errarr['buildername_error'];        ?></span>-->
                                </div>  

                                <label for="builderadd" class="col-sm-3 control-label"><?php echo __('lblbuilderadd'); ?><span style="color: #ff0000">*</span></label>   
                                <div class="col-sm-3">
                                    <?php echo $this->Form->input('builderadd', array('label' => false, 'id' => 'builderadd', 'type' => 'text', 'class' => 'form-control', 'maxlength' => '100')); ?>
                                  <!--<span id="builderadd_error" class="form-error"><?php //echo $errarr['builderadd_error'];        ?></span>-->
                                </div>
                            </div>     
                        </div>
                        <div  class="rowht">&nbsp;</div>
                        <div class="row" id="idbank">
                            <div class="form-group">
                                <label for="bankbuilder" class="col-sm-3 control-label"><?php echo __('lblbankname'); ?><span style="color: #ff0000">*</span></label>    
                                <div class="col-sm-3">
                                    <?php echo $this->Form->input('bankname', array('label' => false, 'id' => 'bankname', 'type' => 'text', 'class' => 'form-control', 'maxlength' => '100')); ?>
                                    <!--<span id="bankname_error" class="form-error"><?php //echo $errarr['bankname_error'];        ?></span>-->
                                </div>  

                                <label for="bankadd" class="col-sm-3 control-label"><?php echo __('lblbankadd'); ?><span style="color: #ff0000">*</span></label>   
                                <div class="col-sm-3">
                                    <?php echo $this->Form->input('bankadd', array('label' => false, 'id' => 'bankadd', 'type' => 'text', 'class' => 'form-control', 'maxlength' => '100')); ?>
                                  <!--<span id="bankadd_error" class="form-error"><?php //echo $errarr['bankadd_error'];        ?></span>-->
                                </div>
                            </div>     
                        </div>

                        <div class="row" id="rowifsc">
                            <div  class="rowht">&nbsp;</div>
                            <div class="form-group">

                                <label for="ifsc" class="col-sm-3 control-label"><?php echo __('lblifsccode'); ?><span style="color: #ff0000">*</span></label>    
                                <div class="col-sm-3">
                                    <?php echo $this->Form->input('ifsc', array('label' => false, 'id' => 'ifsc', 'type' => 'text', 'class' => 'form-control', 'maxlength' => '20')); ?>
        ...
        <!--                        <label for="Division" class="col-sm-3 control-label"><?php echo __('lbladmdivision'); ?></label>    
                        ...
                        <div class="row" id="deed_office">
                            <div class="form-group">
                                <label for="office" class="col-sm-3 control-label" id="lbl_deed_writer_off"><?php echo __('lblselofc'); ?><span style="color: #ff0000">*</span></label>    
                                <div class="col-sm-3" >
                                ...
                                <label for="office" class="col-sm-3 control-label" id="lbl_licence_no"><?php echo __('lbllicensenumber'); ?><span style="color: #ff0000">*</span></label>    
                                <div class="col-sm-3" >
                        ...
                        <div class="row" id="adv_bar">
                            <div class="form-group">
                                <label for="office" class="col-sm-3 control-label" id="lbl_name_of_bar"><?php echo __('lblnameofbar'); ?><span style="color: #ff0000">*</span></label>    
                                <div class="col-sm-3" >
...
<!--                    <div class="box-body" id="nri_details">
                        <div class="row">
                            <div class="form-group">
                                <label for="building" class="col-sm-3 control-label"><?php //echo __('lblAddress'); ?><span style="color: #ff0000">*</span></label>    
                                <div class="col-sm-3">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row" id="idcompany">
                            <div  class="rowht">&nbsp;</div>
                            <div class="form-group">
                                <label for="firmdetails" class="col-sm-3 control-label"><?php echo __('Firm Details'); ?></label>
                                <div class="col-sm-3">
                                    <?php echo $this->Form->input('firmdetails', array('label' => false, 'id' => 'firmdetails', 'type' => 'text', 'class' => 'form-control input-sm')); ?>  
                                    <span id="firmdetails_error" class="form-error"><?php //echo $errarr['firmdetails_error'];             ?></span>
                                </div>
                                <label for="authperson" class="col-sm-3 control-label"><?php echo __('Authorised Person'); ?></label>
                                <div class="col-sm-3">
                                    <?php echo $this->Form->input('authperson', array('label' => false, 'id' => 'authperson', 'type' => 'text', 'class' => 'form-control input-sm')); ?>  
                                    <span id="authperson_error" class="form-error"><?php //echo $errarr['authperson_error'];             ?></span>
                                </div>
                            </div>
                        </div>
                        <div  class="rowht">&nbsp;</div>
                        <div class="row" id="uiddiv">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3" id="pantxt">
                                    <?php echo $this->Form->input('uid', array('label' => false, 'id' => 'uid', 'type' => 'text', 'class' => 'form-control ', 'onblur' => 'checkuid()', 'maxlength' => '12', 'readonly', 'onfocus' => '$(this).removeAttr("readonly");')); ?>
