                ...
                <div class="box-body">
                    <div class="row">
                        <div class="form-group">
                            <div class="col-sm-3"><?php echo __('Citizen Type'); ?></div>
                            <div class="col-sm-3"> <?php echo $this->Form->input('citizen_type', array('type' => 'radio', 'options' => array('I' => '&nbsp;' . __('Indian') . '&nbsp;&nbsp;&nbsp;&nbsp;', 'N' => '&nbsp;' . __('NRI') . '&nbsp;&nbsp;&nbsp;'), 'value' => 'I', 'legend' => false, 'div' => false, 'id' => 'citizen_type')); ?></div>                            

                            <label for="contact_person" class="col-sm-3 control-label" id='lbldeed_writer'><?php echo __('Select User Type'); ?></label>  
                            <div class="col-sm-3">  <?php echo $this->Form->input('reg_type', array('label' => false, 'id' => 'reg_type', 'class' => 'form-control input-sm', 'options' => array($reg_type))); ?></div>                            
                ...
                <div class="box box-primary">
                    <div class="box-body">
                        <div class="row" id="idbuilder">
                            <div class="form-group">
                                <label for="builder" class="col-sm-3 control-label"><?php echo __('lblbuildercmpname'); ?></label>    
                                <div class="col-sm-3">
                                ...
                                <label for="builderadd" class="col-sm-3 control-label"><?php echo __('lblbuilderadd'); ?></label>   
                                <div class="col-sm-3">
                        ...
                        <div class="row" id="idbank">
                            <div class="form-group">
                                <label for="bankbuilder" class="col-sm-3 control-label"><?php echo __('lblbankname'); ?></label>    
                                <div class="col-sm-3">
                                ...
                                <label for="bankadd" class="col-sm-3 control-label"><?php echo __('lblbankadd'); ?></label>   
                                <div class="col-sm-3">
                        ...
                        <div class="row" id="rowifsc">
                            ...
                            <div class="form-group">
                                ...
                                <label for="ifsc" class="col-sm-3 control-label"><?php echo __('lblifsccode'); ?></label>    
                                <div class="col-sm-3">
