...
//        $("#hint_answer").attr("autocomplete", "off");
        ...
        $('#state_id').change(function () {
            ...
            {
                var sc = '<option value="empty">-</option>';
                $.each(data, function (index, val) {
                    sc += "<option value=" + index + ">" + val + "</option>";
                });
                $("#district_id option").remove();
                $("#district_id").append(sc);
//                if (sc.option[sc.selectedIndex].value === 'empty') {
//                        $("#othstateaddress").val('');
//                }
            });
        })
...
<?php } ?>
        ...
        $('select').change(function () {
            ...
            var $address = $("#othstateaddress");
            var state_id = $("#state_id").find("option:selected").text();
            var district_id = $("#district_id").find("option:selected").text();
            var taluka_id = $("#taluka_id").find("option:selected").text();
            var val = state_id + "," + district_id + "," + taluka_id;
            $address.val(val);
        });
    });
...
<div class="row">
    <div class="col-lg-12">
            ...
            <div class="box-header with-border">
                ...
                <div class="box box-primary" >
                    ...
                    <div class="box-body" id="contact_details">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <label for="state" class="col-sm-3 control-label"><?php echo __('lblSelect'); ?>&nbsp;<?php echo __('lbladmstate'); ?></label>
                                <div class="col-sm-3">
        ...
        <!--                        <label for="Division" class="col-sm-3 control-label"><?php echo __('lbladmdivision'); ?></label>    
                        ...
                        <div class="row">
                            <div class="form-group">
                                <label for="district" class="col-sm-3 control-label"><?php echo __('lblSelect'); ?>&nbsp;<?php echo __('lbladmdistrict'); ?></label>
                                <div class="col-sm-3">
                                    <?php echo $this->Form->input('district_id', array('label' => false, 'id' => 'district_id', 'class' => 'form-control input-sm', 'empty' => '-', 'options' => array())); ?>
                                    <!--<span id="district_id_error" class="form-error"><?php //echo $errarr['district_id_error'];                       ?></span>-->
                                </div>
                                <label for="taluka" class="col-sm-3 control-label"><?php echo __('lblSelect'); ?>&nbsp;<?php echo __('lbladmtaluka'); ?></label>
                                <div class="col-sm-3">
                                    <?php echo $this->Form->input('taluka_id', array('label' => false, 'id' => 'taluka_id', 'class' => 'form-control input-sm', 'empty' => '-', 'options' => array())); ?>
                        ...
                        <div class="row">
                            <div class="form-group">
                                <label for="othstateaddress" class="col-sm-3 control-label"><?php echo __('Address'); ?><span style="color: #ff0000">*</span></label> 
                                <div class="col-sm-9">
                                    <?php echo $this->Form->input('othstateaddress', array('label' => false, 'type' => 'text', 'id' => 'othstateaddress', 'class' => 'form-control')); ?>
                                 <!--<span id="taluka_id_error" class="form-error"><?php //echo $errarr['taluka_id_error'];                       ?></span>-->
                                </div>
                            </div>   
                        </div>
                        ...
                        <div class="row" id="adv_bar">
                            <div class="form-group">
                                <label for="office" class="col-sm-3 control-label" id="lbl_name_of_bar"><?php echo __('Name of Unit'); ?><span style="color: #ff0000">*</span></label>    
                                <div class="col-sm-3" >
                    ...
                    <div class="box-body">
                        ...
                        <!--                        <div class="row" id="uiddiv">
                                                    <div class="form-group">
                                                        ...
                                                        <label for="pan_no" class="col-sm-3 control-label" id="pan_lable"><?php //echo __('lbluid');                          ?></label>
                                                        <div class="col-sm-3" id="pantxt">
