        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <center><h3 class="box-title headbolder"><?php echo __('lblassignroletouser'); ?></h3></center>
                 <a  href="<?php echo $this->webroot;?>helpfiles/admin/assign_role_<?php echo $laug; ?>.html" class="btn btn-default pull-right " target="_blank"> <?php echo  __('help');?> <span class="fa fa-question fa-circle-o"></span></a>
            </div>
            <div class="box-body">
                <div class="row">
