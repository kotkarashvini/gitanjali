...
<div class="login-box" id="divhintdetails" hidden="true">
    ...
    <div class="login-box-body log_border">
        ...
        <div class="form-group has-feedback">
            <?php 
echo $this->Form->input('hint_question', array('label' => false, 'id' => 'hint_question', 'type' => 'text', 'style' => 'width:100%; ', 'class' => 'form-control', 'readonly' => 'readonly', 'value' => $hintquestion[0]['hint']['questions_en'])); 
?>
        </div>
