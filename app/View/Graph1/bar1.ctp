...
<input type='text' value='<?php echo $filter1; ?>' name='filter1' id='filter1'/>
<input type='text' value='<?php echo $filter2; ?>' name='filter2' id='filter2'/>
<br><br><br><br>
    ...
    ?>
        {
            ...
            Office: "<?php echo $data1['officename']; ?>",
            Document: "<?php echo $data1['document_type']; ?>",
