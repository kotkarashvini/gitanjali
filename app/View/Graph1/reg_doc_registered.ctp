...
<?php echo $this->Form->create('reg_doc_registered', array('id' => 'reg_doc_registered', 'autocomplete' => 'off')); ?>
    ...
    <div class="box-header with-border">
        <center><h3 class="box-title headbolder"><?php echo 'Registered Document Graph'; ?></h3></center>
    </div>
    <div class = "box box-primary">
        <div class="box-body">
