<script type="text/javascript">
    $(document).ready(function () {
        ...
        $.post(host + 'LegacyIdentification/get_identification_feilds', {csrftoken: csrftoken, type: type}, function (fields)
        {
            if (fields) {
                ...
                window.location.href = "<?php echo $this->webroot; ?>LegacyIdentification/identifier/<?php echo $this->Session->read('csrftoken'); ?>";
                            }
                                    ...
                                    if (fields) {
                                        ...
                                        window.location.href = "<?php echo $this->webroot; ?>LegacyIdentification/identifier/<?php echo $this->Session->read('csrftoken'); ?>";
                                            ...
                                            function set_master(master_id, office_id) {
                                                ...
                                                $.post(host + 'LegacyIdentification/get_identification_feilds', {master_id: master_id, csrftoken: csrftoken, type: type}, function (data)
                                                {
                                            ...
                                            {
                                                $.post(host + 'LegacyIdentification/get_identification_feilds', {id: id, csrftoken: csrftoken, type: type}, function (data)
                                                {
                                                    $("#identification_fields").html(data);
                                                    $(document).trigger('_page_ready');
                                                    $('#hfid').val(id);
                                            ...
                                            function formdelete(id) {
                                                ...
                                                if (result) {
                                                    $.post('<?php echo $this->webroot; ?>LegacyIdentification/delete_identifire', {id: id, csrftoken: csrftoken}, function (data1)
                                                    {
...
echo $this->Form->create('identification', array('id' => 'identification', 'class' => 'form-vertical', 'autocomplete' => 'off'));
                ...
                <table id="tableidentification" class="table table-striped table-bordered table-hover">  
                    ...
                    <?php for ($i = 0; $i < count($identification); $i++) { ?>
                        <tr>
                            ...
                            echo $identification[$i][0]['desc_en'];
                            ...
                            <td>
                                ...
                                <?php } ?>
                                <a <?php echo $this->Html->Link("Delete", array('action' => 'delete_identifire', $this->Session->read('csrftoken'), $identification[$i][0]['id']), array('escape' => false, 'data-toggle' => 'tooltip', 'title' => __('Delete'), 'class' => "btn btn-info"), array('Are you sure?')); ?></a>
