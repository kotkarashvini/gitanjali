...
<div class="row">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <!--<button type="button" class="btn btn-primary " data-toggle="modal" data-target="#modelschemedetails"><?php echo __('Scheme'); ?></button>&nbsp;-->
                       <?php if($this->Session->read('role_type') == 'A' && $this->Session->read("user_role_id") == '999976' ){
                           
                       }else{
                   echo $this->Html->link(__('lblnewdocument'), array('controller' => 'Legacyentry', 'action' => 'delete_session'), array('class' => 'btn btn-primary')); 
                       }?>
   ...
   <tbody>
                               ...
                               if(!empty($demodata)) {
                                    ...
                                    ?>
                                    <tr>
                                      <?php if ($demodata1[0]['last_status_id'] == 1) { ?>
                                      <td class="width5"><?php echo $this->Html->link("Select", array('controller' => 'Legacyentry', 'action' => 'getid', $demodata1[0]['token_no'])); ?></td>
                                      <?php } else { ?>
                                      <td class="width10"><?php echo $this->Html->link("Select", array('controller' => 'Legacyentry', 'action' => 'getid', $demodata1[0]['token_no']), array('target' => '_blank', 'onclick' => 'return false')); ?></td>
                                       <?php } ?>
                                       ...
                                       <?php if ($doc_lang != 'en') { ?>
                                        ...
                                        <?php } else {?>
                                         ...
                                         <td class="width5"><?php echo $this->Html->link('PDF', array('controller' => 'LegacyReportsummary', 'action' => 'legacy_report', $demodata1[0]['token_no'], 'D')); ?></td>
                                    </tr>
<?php }} else{ ?>
