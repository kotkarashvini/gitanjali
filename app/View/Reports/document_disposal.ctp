...
<?php echo $this->Form->create('document_disposal', array('id' => 'document_disposal')); ?>
<div class="row">
    <div class="col-lg-12">
        <div class = "box box-primary">
            <div class = "box-header with-border" style="color: #8B0000">
                <center><h3 class = "box-title headbolder">Document Disposal Report </h3></center>
            </div>
            <div class="box-body">
            ...
            <div class="row center">
             ...
             <?php }if(!empty($htmldesign1)) { ?>
            <div class="row center">
                <div class="form-group col-sm-12" > 
                    <!--<div class="col-sm-1"></div>-->                   
                    <div class="col-sm-12"><?php echo $htmldesign1; ?></div>
                    <!--<div class="col-sm-1"></div>-->          
                </div>
            </div>
            <?php }  ?><br><br>
