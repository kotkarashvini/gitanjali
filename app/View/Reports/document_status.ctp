...
<?php echo $this->Form->create('document_status', array('id' => 'document_status')); ?>
<div class="row">
    <div class="col-lg-12">
        <div class = "box box-primary">
            <div class = "box-header with-border" style="color: #8B0000">
                <center><h3 class = "box-title headbolder">Document Status Statistic </h3></center>
            </div>
            <div class="box-body">
            ...
            <div class="row center">
                <div class="form-group" > <div class="col-sm-2"></div>                   
                    <div class="col-sm-8"><?php echo $htmldesign; ?></div>
                    <div class="col-sm-2"></div>          
                </div>
            </div><br><br>
            <div class="row center">
