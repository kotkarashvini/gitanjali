...
<?php echo $this->Form->create('rpt_income_tax_office', array('id' => 'rpt_income_tax_office', 'autocomplete' => 'off')); ?>
<div class="row">
    <div class="col-lg-12">
            ...
            <div class="box-body">
                 <div class="row" id="divDate">
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <?php echo $this->Form->input('office_id', array('type' => 'select', 'empty' => '--All Offices--', 'options' => $office, 'label' => false, 'multiple' => false, 'id' => 'office_id', 'class' => 'form-control input-sm')); ?>
                        </div>
                    </div>     
                </div>
        ...
        if (!empty($itax)) {
            ...
            <div class="box box-primary">
                <div class="box-body">
                    <div>
                        <center><h4 class = "box-title headbolder"><?php echo __('Income Tax For '); ?> <?php echo $officename; ?> </h4></center>
                    </div>
