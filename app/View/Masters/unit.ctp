            ...
            <div class="box-body">
                ...
                <div  class="row" id="conversiondiv">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <label for="unit_cat_id" class="control-label"><?php echo __('lblunitcategory'); ?>:<span style="color: #ff0000">*</span></label> 
                            <?php echo $this->Form->input('unit_cat_id', array('label' => false, 'id' => 'unit_cat_id', 'class' => 'form-control input-sm', 'options' => array('empty' => '--Select--', $unit_cat))); ?>
...
//creating dyanamic table header using same array of config language
                            ...
                            <th class="center"><?php echo __('lblconversionformula'); ?></th>
                             <th class="center"><?php echo __('lblunitcategory'); ?></th>
                            <th class="center width10"><?php echo __('stdunit'); ?></th>
                        ...
                        <?php foreach ($unitrecord as $unitrecord1): ?>
                            <tr>
                                ...
                                <td ><?php echo $unitrecord1['unit']['conversion_formula']; ?></td>
                                 <td ><?php echo $unitrecord1[0]['unit_cat_desc_'. $laug]; ?></td>
                                ...
                                <td >
                                    ...
                                    <?php } ?>
                                                ('<?php echo $unitrecord1[0]['unit_id']; ?>'),
                                                        
                                                        ('<?php echo $unitrecord1[0]['standard_units']; ?>'),
                                                         ('<?php echo $unitrecord1[0]['unit_cat_id']; ?>'),
                                                        ('<?php echo $unitrecord1[0]['conversion_formula']; ?>'),
                                                        ('<?php echo $unitrecord1[0]['remark']; ?>'));">
                                        <span class="glyphicon glyphicon-pencil"></span>
                                    </button>
                                    <a <?php echo $this->Html->Link($this->Html->tag('span', '', array('class' => 'glyphicon glyphicon-remove')), array('action' => 'unit_delete', $unitrecord1['unit']['unit_id']), array('escape' => false, 'data-toggle' => 'tooltip', 'title' => __('Delete'), 'class' => "btn btn-default"), array('Are you sure?')); ?></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
