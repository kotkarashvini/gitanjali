...
//              $("#vrifycode1").show();
        ...
        $('#corp_id').change(function () {
            ...
            $('#office_id').change(function () {
                ...
                $.getJSON('<?php echo $this->webroot; ?>Masters/get_office_dataget_office_data', {office: office}, function (data)
                {
    ...
    <div class="col-lg-12">
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="form-group">
                        <label for="" class="col-sm-3 control-label"><?php echo __('lblcorporation'); ?></label> 
                        <div class="col-sm-3">
...
<!--                    <div class="col-sm-1"></div>
                ...
                <div class="row " id="vrifycode1" hidden="true">
                    ...
                    <label for="villagemappingcode" class="col-sm-3 control-label"> <?php echo __('lblEnterVillageMappingCode'); ?><span style="color: #ff0000">*</span></label> 
                        <div class="col-sm-3">
