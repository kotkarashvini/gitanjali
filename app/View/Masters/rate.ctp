        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a  href="<?php echo $this->webroot; ?>helpfiles/Property Rate Chart/rate_<?php echo $language; ?>.html" class="btn btn-small btn-info" target="_blank"> <i class="fa fa-info-circle"></i>  <?php echo __('Help'); ?> </a>
                </div> 
            </div>
            <div class="box-body">
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <label for="district_id" class="control-label"><?php echo __('lblfineyer'); ?><span style="color: #ff0000">*</span></label>
                        ...
                        <div class="col-sm-2">
                            <label for="ratetype_id" class="control-label"><?php echo __('lblratetype'); ?><span style="color: #ff0000">*</span></label>
                            <?php echo $this->Form->input('ratetype_id', array('options' => array($ratetypedata), 'id' => 'ratetype_id', 'label' => false, 'class' => 'form-control input-sm')); ?>
                            <span id="ratetype_id_error" class="form-error"><?php echo $errarr['ratetype_id_error']; ?></span>
                        </div>

                        <div class="col-sm-2">
                            <label for="district_id" class="control-label"><?php echo __('lbleffedate'); ?><span style="color: #ff0000">*</span></label>
                            <?php echo $this->Form->input('effective_date', array('type' => 'text', 'id' => 'effective_date', 'label' => false, 'class' => 'form-control input-sm')); ?>
                        ...
                        <div class="col-sm-2">
                            ...
                            <?php echo $this->Form->input('taluka_id', array('options' => array($taluka), 'empty' => '--select--', 'id' => 'taluka_id', 'label' => false, 'class' => 'form-control input-sm', 'disabled' => 'disabled')); ?>
                            <span id="taluka_id_error" class="form-error"><?php echo $errarr['taluka_id_error']; ?></span>
                        </div>

                        <div class="col-sm-2">
                            <label for="district_id" class="col-sm-2 control-label"><?php echo __('lbladmvillage'); ?></label>
                            <?php echo $this->Form->input('village_id', array('options' => array($villagenname), 'empty' => '--select--', 'id' => 'village_id', 'label' => false, 'class' => 'form-control input-sm', 'disabled' => 'disabled')); ?>
                        ...
                        <div class="form-group">
                            ...
                            <?php if ($configure[$i]['levelconfig']['is_level_1_id'] == 1) { ?>
                                <div class="col-sm-2"   divlevel1field>
                                    <?php echo $this->Form->input('level1_id', array('options' => array($level1propertydata), 'empty' => '--select--', 'id' => 'level1_id', 'label' => false, 'class' => 'form-control input-sm', 'disabled' => 'disabled')); ?>
                                ...
                                <div class="col-sm-2" id="divlevel1list" hidden="true">
                                    <?php echo $this->Form->input('level1_list_id', array('options' => array($level1propertylist), 'empty' => '--select--', 'id' => 'level1_list_id', 'label' => false, 'class' => 'form-control input-sm', 'disabled' => 'disabled')); ?>
                            ...
                            <?php if ($configure[$i]['levelconfig']['is_level_2_id'] == 1) { ?>
                                <div class="col-sm-2" id="divlevel2" hidden="true">
                                    <?php echo $this->Form->input('level2_id', array('options' => array($level2propertydata), 'empty' => '--select--', 'id' => 'level2_id', 'label' => false, 'class' => 'form-control input-sm', 'disabled' => 'disabled')); ?>
...
//                                echo $this->Form->input('slab_rate_flag', array('options' => $slabrateflag, 'label' => false, 'id' => 'slab_rate_flag', 'class' => 'form-control input-sm'));
                ...
                <div class="row" style="text-align: center">
                    <div class="form-group">
                        <button type="button" id="btnadd" name="btnadd" class="btn btn-primary " style="text-align: center;"  onclick="javascript: return formadd();">
                        ...
                        <table id="tableratedata" class="table table-striped table-bordered table-condensed" width="100%">  
                            ...
                            <tbody>
                                <?php for ($i = 0; $i < count($raterecord); $i++) { ?>
                                    <tr>
                                        <td style="text-align: center;"><?php echo $raterecord[$i][0]['village_name_en']; ?></td>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-2"><?php echo $gridrecord[$i][0]['village_name_en']; ?></div>
