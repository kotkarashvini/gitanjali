...
//    -------------------------------------------------------
    ...
    function formupdate(emp_id,emp_code, salutation, emp_fname, emp_mname, emp_lname, office_id, qualification_id, building_no, flat_no,
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
				...
				<div class="box-tools pull-right">
                    <a  href="<?php echo $this->webroot; ?>helpfiles/admin/employee.html" class="btn btn-small btn-info" target="_blank"> <i class="fa fa-info-circle"></i>  <?php echo __('Help'); ?> </a>
                </div>
            </div>
            <div class="box-body">
                <div class="row">
                            ...
                            <tr>
                                ...
                                <td class="width10 center">
                                    <button id="btnupdate" name="btnupdate" type="button" data-toggle="tooltip" title="Edit" class="btn btn-default "   onclick="javascript: return formupdate(
                                                        ('<?php echo $employeerecord1[0]['emp_id']; ?>'),
