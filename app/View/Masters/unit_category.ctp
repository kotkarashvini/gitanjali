        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a  href="<?php echo $this->webroot; ?>helpfiles/unitcategory/unitcategory_<?php echo $laug; ?>.html" class="btn btn-small btn-info" target="_blank"> <i class="fa fa-info-circle"></i>  <?php echo __('Help'); ?> </a>
                </div> 
            </div>
            <div class="box-body">
...
//  creating dyanamic text boxes using same array of config language
                    foreach ($languagelist as $key => $langcode) {
                        ...
                        <div class="col-md-3">
                            ...
                            <?php echo $this->Form->input('unit_cat_desc_' . $langcode['mainlanguage']['language_code'], array('label' => false, 'id' => 'unit_cat_desc_' . $langcode['mainlanguage']['language_code'], 'class' => 'form-control input-sm', 'type' => 'text', 'maxlength' => '100')) ?>
                ...
                <div class="row center">
                    <div class="form-group">
                        <div class="col-sm-12 tdselect">
                            ...
                            <a href="<?php echo $this->webroot; ?>Masters/unit_category" class="btn btn-info "><?php echo __('btncancel'); ?></a>
                        ...
                        foreach ($unitcatdata as $unitcatdata1) {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a <?php echo $this->Html->Link($this->Html->tag('span', '', array('class' => 'fa fa-pencil')), array('action' => 'unit_category', $unitcatdata1[0]['unit_cat_id']), array('escape' => false, 'data-toggle' => 'tooltip', 'title' => __('Edit'), 'class' => "btn-sm btn-default"), array('Are you sure to Edit?')); ?>
                                    <a <?php echo $this->Html->Link($this->Html->tag('span', '', array('class' => 'fa fa-remove')), array('action' => 'delete_unit_category', $unitcatdata1[0]['unit_cat_id']), array('escape' => false, 'data-toggle' => 'tooltip', 'title' => __('Delete'), 'class' => "btn-sm btn-default"), array('Are you sure?')); ?></a>
                                </td>  </tr> 
                        <?php } ?>
