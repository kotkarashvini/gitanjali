...
<script type="text/javascript">
    ...
    function activate(id)
    {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo $this->webroot; ?>Masters/approve_citizen",
            data: {'id': id, 'csrftoken': csrftoken},
            success: function (data) {

                if (data == 1)
                {
                    alert('Citizen User Activated.');
                    window.location.reload();
                    return false;
                }
                else {
                    alert('Citizen User is not Activated.Please try again.');
                }
            }
        });
    ...
    function deactivate(id)
    {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo $this->webroot; ?>Masters/reject_citizen",
            data: {'id': id, 'csrftoken': csrftoken},
            success: function (data) {
                if (data == 1)
                {
                    alert('Citizen User Deactivated.');
                    window.location.reload();
                    return false;
                }
    ...
    <div class="col-lg-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <center><h3 class="box-title headbolder"><?php echo __('Activate/Deactivate Citizen Users'); ?></h3></center>
            </div>
            <div class="box-body">
