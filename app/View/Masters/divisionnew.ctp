...
<?php echo $this->Form->create('divisionnew', array('id' => 'divisionnew', 'autocomplete' => 'off')); ?>
                    ...
                    <div class="form-group">
                        ...
                        foreach ($languagelist as $key => $langcode) {
                            ...
                            <div class="col-md-3">
                                ...
                                <?php echo $this->Form->input('division_name_' . $langcode['mainlanguage']['language_code'], array('label' => false, 'id' => 'division_name_' . $langcode['mainlanguage']['language_code'], 'class' => 'form-control input-sm', 'type' => 'text', 'maxlength' => '255')) ?>
                        ...
                        <thead >  
                            <tr>  
                                <?php foreach ($languagelist as $langcode) { ?>
                                    <th class="center"><?php echo __('lblDivisionname') . " ( " . $langcode['mainlanguage']['language_name'] . ")"; ?></th>
                                <?php } ?>
                        ...
                        <tbody>
                            <?php foreach ($divisionrecord as $divisionrecord1): ?>
                                <tr>
                                    ...
                                    foreach ($languagelist as $langcode) {
                                        ?>
                                        <td ><?php echo $divisionrecord1['divisionnew']['division_name_' . $langcode['mainlanguage']['language_code']]; ?></td>
                                    <?php } ?>
                                    <td >
                                        <button id="btnupdate" name="btnupdate"  type="button" data-toggle="tooltip" title="Edit" class="btn btn-default "  
                                                ...
                                                <?php foreach ($languagelist as $langcode) { ?>
                                                                    ('<?php echo $divisionrecord1['divisionnew']['division_name_' . $langcode['mainlanguage']['language_code']]; ?>'),
                                                <?php } ?>
                                                                ('<?php echo $divisionrecord1['divisionnew']['id']; ?>'));">
                                            <span class="glyphicon glyphicon-pencil"></span>
                                        </button>
                                        <?php
                                        $newid = $this->requestAction(
                                                array('controller' => 'Masters', 'action' => 'encrypt', $divisionrecord1['divisionnew']['id'], $this->Session->read("randamkey"),
                                        ));
                                        ?>
                                        <a <?php echo $this->Html->Link($this->Html->tag('span', '', array('class' => 'glyphicon glyphicon-remove')), array('action' => 'divisionnew_delete', $newid), array('escape' => false, 'data-toggle' => 'tooltip', 'title' => __('Delete'), 'class' => "btn btn-default"), array('Are you sure?')); ?></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
