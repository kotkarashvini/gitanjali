...
<div class="row">
    <?php
//    echo $this->Form->create('sro_approve_deedwriter_all', array(
//        'url' => array('controller' => 'Masters', 'action' => 'sro_approve_deedwriter_all')), array('class' => 'form-horizontal'))
    ?> 
    <?php echo $this->Form->create('sro_approve_deedwriter_all'); ?>
    <div class="col-lg-12">
            ...
            <div class="box-body">
                <div class="col-md-6">
                   ...
                   // if (isset($demo1)) {
                    ...
                    //    echo $this->Form->input('user_id', array('label' => false, 'id' => 'user_id', 'type' => 'hidden', 'value' => $demo[0][0]['user_id']));
                   // }
                    ?>
                </div>
            </div>
                    ...
                    for ($i = 0; $i < count($advocate); $i++) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php
                                ?>
                                <!--<a href="<?php echo $this->webroot; ?>Masters/sro_approve_deedwriter_all_edit/<?php echo $advocate[$i][0]['id']; ?>" class="btn-sm btn-default"><span class="fa fa-pencil"></span> </a>-->    
                            <button type="button" class="btn btn-success" id="btnnewdock" name="btnnewdock" onclick="location.href = '<?php echo $this->Html->url(array('controller' => 'Masters', 'action' => 'sro_approve_deedwriter_all_edit', $advocate[$i][0]['user_id'])); ?>';">
                                    <span class="glyphicon glyphicon-"></span><?php echo __('Edit'); ?>
                                </button>
                    ...
                    <?php for ($i = 0; $i < count($usrdata); $i++) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php } ?>
    <!--<button id="II" class="btn btn-primary" onClick="<?php ?>"><?php echo __('Edit'); ?></button>--> 
                                <?php //$newid = 1;  ?>
                                <?php //echo $this->Html->link(__('Edit'), array('controller' => 'Masters', 'action' => 'sro_approve_deedwriter_all_edit', $usrdata[$i][0]['id']), array('class' => "btn btn btn-info")); ?>  
                                <!--<a href="<?php echo $this->webroot; ?>Masters/sro_approve_deedwriter_all_edit/<?php echo $usrdata[$i][0]['id']; ?>" class="btn-sm btn-default"><span class="fa fa-pencil"></span> </a>--> 
                                <button type="button" class="btn btn-success" id="btnnewdock" name="btnnewdock" onclick="location.href = '<?php echo $this->Html->url(array('controller' => 'Masters', 'action' => 'sro_approve_deedwriter_all_edit', $usrdata[$i][0]['user_id'])); ?>';">
                                    <span class="glyphicon glyphicon-"></span><?php echo __('Edit'); ?>
                                </button>
                            </td>
                        </tr>
