...
<script>
    function formadd() {
        ...
        if (!level_3_desc_en.match(alphanumsapcedot) || level_3_desc_en.length > 100)
        {
            $('#level_3_desc_en').focus();
    ...
    function formupdate(level_3_desc_en, surveynotype_id, village_id, id) {
...
<?php echo $this->Form->create('level3', array('id' => 'level3', 'autocomplete' => 'off')); ?>
<?php echo $this->Form->input('csrftoken', array('label' => false, 'id' => 'csrftoken', 'type' => 'hidden', 'class' => 'form-control', 'value' => $this->Session->read("csrftoken"))); ?>
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-primary">
            <div class="panel-heading" style="text-align: center"><b><?php echo __('lblLevel3'); ?></b></div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <?php echo $this->Form->input('level_3_desc_en', array('label' => false, 'id' => 'level_3_desc_en', 'class' => 'form-control input-sm', 'type' => 'text')) ?>
                            </div>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        ...
                                        <button id="btndelete" name="btndelete" class="btn btn-default " style="text-align: center;" 
                                                onclick="javascript: return formdelete(('<?php echo $level3record[$i][0]['id']; ?>'));">
