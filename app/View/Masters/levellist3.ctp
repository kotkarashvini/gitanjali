...
//            alert(taluka);return false;
        ...
        $('#village_id').change(function () {
            ...
            $.getJSON("get_level_name", {village: village, token: token}, function (data)
            {
                ...
                $("#level_3_id").prop("disabled", false);
                $("#level_3_id option").remove();
                $("#level_3_id").append(sc);
            });
        })
...
<script>
    function formadd() {
        ...
        if (!list_3_desc_en.match(alphanumsapcedot) || list_3_desc_en.length > 100)
        {
            $('#list_3_desc_en').focus();
    ...
    function formupdate(list_3_desc_en, id, level_3_id, level_3_from_range, level_3_to_range, village_id) {
        document.getElementById("actiontype").value = '1';
        $("#village_id").prop("disabled", false);
        $("#level_3_id").prop("disabled", false);
...
<?php echo $this->Form->create('levellist3', array('id' => 'levellist3', 'autocomplete' => 'off')); ?>
<?php echo $this->Form->input('csrftoken', array('label' => false, 'id' => 'csrftoken', 'type' => 'hidden', 'class' => 'form-control', 'value' => $this->Session->read("csrftoken"))); ?>
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-primary">
            <div class="panel-heading" style="text-align: center"><b><?php echo __('lblLevel3list'); ?></b></div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <?php echo $this->Form->input('level_3_id', array('options' => array($Level3name), 'empty' => '--select--', 'id' => 'level_3_id', 'class' => 'form-control input-sm', 'label' => false, 'disabled' => 'disabled')); ?>
                            </div>
                            <label for="level_3_id" class="col-sm-2 control-label"><?php echo __('lblLevel3list'); ?><span style="color: #ff0000">*</span></label>    
                            <div class="col-sm-2">
                                <?php echo $this->Form->input('list_3_desc_en', array('label' => false, 'id' => 'list_3_desc_en', 'class' => 'form-control input-sm', 'type' => 'text')) ?>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <div class="col-sm-2">
                                <?php echo $this->Form->input('level_3_from_range', array('label' => false, 'id' => 'level_3_from_range', 'class' => 'form-control input-sm', 'type' => 'text')) ?>
                            </div>
                            <label for="usage_sub_catg_desc_en" class="col-sm-2 control-label"><?php echo __('lblrangeto'); ?><span style="color: #ff0000">*</span></label>    
                            <div class="col-sm-2">
                                <?php echo $this->Form->input('level_3_to_range', array('label' => false, 'id' => 'level_3_to_range', 'class' => 'form-control input-sm', 'type' => 'text')) ?>
                            </div>
                            ...
                            <?php for ($i = 0; $i < count($levellist3record); $i++) { ?>
                                <tr>
                                    ...
                                    <?php if ($this->Session->read("sess_langauge") == 'en') { ?>
                                        <td style="text-align: center;"><?php echo $levellist3record[$i][0]['level_3_desc_en']; ?></td>
                                        <td style="text-align: center;"><?php echo $levellist3record[$i][0]['list_3_desc_en']; ?></td>
                                        ...
                                        <td style="text-align: center;">
                                            <button id="btnupdate" name="btnupdate" class="btn btn-default " style="text-align: center;" 
                                                    onclick="javascript: return formupdate(
                                                                                            ('<?php echo $levellist3record[$i][0]['list_3_desc_en']; ?>'),
                                                                                            ('<?php echo $levellist3record[$i][0]['id']; ?>'),
                                                                                            ('<?php echo $levellist3record[$i][0]['level_3_id']; ?>'),
                                                                                            ('<?php echo $levellist3record[$i][0]['level_3_from_range']; ?>'),
                                                                                            ('<?php echo $levellist3record[$i][0]['level_3_to_range']; ?>'), ('<?php echo $levellist3record[$i][0]['village_id']; ?>'));">
                                                <span class="glyphicon glyphicon-pencil"></span></button>

                                            <button id="btndelete" name="btndelete" class="btn btn-default " style="text-align: center;" onclick="javascript: return formdelete(('<?php echo $levellist3record[$i][0]['id']; ?>'));">
                                                <span class="glyphicon glyphicon-remove"></span></button>
                                        </td>
                                    <?php } else { ?>
                                        <td style="text-align: center;"><?php echo $levellist3record[$i][0]['level_3_desc_ll']; ?></td>
                                        <td style="text-align: center;"><?php echo $levellist3record[$i][0]['list_3_desc_ll']; ?></td>
                                        <td style="text-align: center;"><?php echo $levellist3record[$i][0]['level_3_from_range']; ?></td>
                                        <td style="text-align: center;"><?php echo $levellist3record[$i][0]['level_3_to_range']; ?></td>
                                        <td style="text-align: center;">
                                            <button id="btnupdate" name="btnupdate" class="btn btn-default " style="text-align: center;" onclick="javascript: return formupdate(('<?php echo $levellist3record[$i][0]['list_3_desc_ll']; ?>'),
                                                                                    ('<?php echo $levellist3record[$i][0]['id']; ?>'), ('<?php echo $levellist3record[$i][0]['level_3_id']; ?>'), ('<?php echo $levellist3record[$i][0]['level_3_from_range']; ?>'), ('<?php echo $levellist3record[$i][0]['level_3_to_range']; ?>'), ('<?php echo $levellist3record[$i][0]['village_id']; ?>'));">
                                                <span class="glyphicon glyphicon-pencil"></span></button>
