...
<script>
    ...
    function formupdate(id, name_en, name_ll, controller, action) {
        document.getElementById("actiontype").value = '1';
        $('#name_en').val(name_en);
        $('#name_ll').val(name_ll);
...
<?php echo $this->Form->create('Menu', array('id' => 'Menu', 'autocomplete' => 'off')); ?>
<?php echo $this->Form->input('csrftoken', array('label' => false, 'id' => 'csrftoken', 'type' => 'hidden', 'class' => 'form-control', 'value' => $this->Session->read("csrftoken"))); ?>
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-primary">
            <div class="panel-heading" style="text-align: center"><b><?php echo __('lblmenu'); ?></b></div>
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            <div class="col-sm-1">&nbsp;</div>
                            <label for="name_en" class="col-sm-2 control-label"><?php echo __('lblmenudesc'); ?>:<span style="color: #ff0000">*</span></label>    
                            <div class="col-sm-3">
                                <?php echo $this->Form->input('name_en', array('label' => false, 'id' => 'name_en', 'class' => 'form-control input-sm', 'type' => 'text')) ?>
                            </div>
                            <label for="action" class="col-sm-2 control-label"><?php echo __('lblmenudescloc'); ?>:<span style="color: #ff0000">*</span></label> 
                            <div class="col-sm-3">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table id="tableMenu" class="table table-striped table-bordered table-hover">  
                                        ...
                                        <tbody>
                                            <?php foreach ($menurecord as $menurecord1): ?>
                                                <tr>
                                                    <td style="text-align: center"><?php echo $menurecord1['Menu']['id']; ?></td>
                                                    <td style="text-align: center;"><?php echo $menurecord1['Menu']['name_' . $laug]; ?></td>
                                                    <td style="text-align: center;"><?php echo $menurecord1['Menu']['controller']; ?></td>
                                                    <td style="text-align: center;"><?php echo $menurecord1['Menu']['action']; ?></td>
                                                    <td style="text-align: center;">
                                                        <button id="btnupdate" name="btnupdate" class="btn btn-default " style="text-align: center;" 
                                                                onclick="javascript: return formupdate(('<?php echo $menurecord1['Menu']['id']; ?>'), ('<?php echo $menurecord1['Menu']['name_en']; ?>'), ('<?php echo $menurecord1['Menu']['name_ll']; ?>'), ('<?php echo $menurecord1['Menu']['controller']; ?>'), ('<?php echo $menurecord1['Menu']['action']; ?>'));">
                                                            <span class="glyphicon glyphicon-pencil"></span>
                                                        </button>
                                                        <button id="btndelete" name="btndelete" class="btn btn-default " style="text-align: center;" 
                                                                onclick="javascript: return formdelete(('<?php echo $menurecord1['Menu']['id']; ?>'));">
                                                            <span class="glyphicon glyphicon-remove"></span>
                                                        </button>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                            <?php unset($menurecord1); ?>
                                        </tbody>
                                    </table> 
