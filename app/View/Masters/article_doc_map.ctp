...
//        
    ...
    function formupdate(article_id, document_id, id) {
        document.getElementById("actiontype").value = '1';
    ...
    <div class="col-lg-12">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <center><h3 class="box-title headbolder"><?php echo __('Article Document Mapping'); ?></h3></center>
				<div class="box-tools pull-right">
                    <a  href="<?php echo $this->webroot; ?>helpfiles/admin/article_document_mapping_en<?php echo $lang; ?>.html" class="btn btn-small btn-info" target="_blank"> <i class="fa fa-info-circle"></i>  <?php echo __('Help'); ?> </a>
                </div> 
            </div>
            <div class="box-body">
                <div class="row">
...
<!--                            <span id="article_id_error" class="form-error"><?php echo $errarr['article_id_error']; ?></span>-->
                        ...
                        <label for="document_id" class="col-sm-2 control-label"><?php echo __('Select Document'); ?><span style="color: #ff0000">*</span></label> 
                        <div class="col-sm-2">
...
<!--                            <span id="document_id_error" class="form-error"><?php echo $errarr['document_id_error']; ?></span>-->
                         ...
                         <label for="Is_Required"><?php echo __('Is Required'); ?></label>   
                            ...
                            <?php echo $this->Form->input('is_required', array('type' => 'radio', 'options' => array('Y' => '&nbsp;Yes&nbsp;&nbsp;', 'N' => '&nbsp;No'), 'value' => 'N', 'legend' => false, 'div' => false, 'class' => 'select', 'id' => 'is_required')); ?>
                ...
                <table id="tablearticlescreen" class="table table-striped table-bordered table-hover">  
                    <thead >  
                        <tr>  
                            ...
                            <th class="center"><?php echo __('Document Names'); ?></th>
                            ...
                            <tr>
                                ...
                                <td >
                                    <button id="btnupdate" name="btnupdate" type="button" data-toggle="tooltip" title="Edit" class="btn btn-default "   onclick="javascript: return formupdate(
                                                    ...
                                                    ('<?php echo $articlegrid1[0]['document_id']; ?>'), ('<?php echo $articlegrid1[0]['id']; ?>'));">
                                        <span class="glyphicon glyphicon-pencil"></span>
                                    </button>
                                    <a <?php echo $this->Html->Link($this->Html->tag('span', '', array('class' => 'glyphicon glyphicon-remove')), array('action' => 'article_doc_map_delete', $articlegrid1[0]['id']), array('escape' => false, 'data-toggle' => 'tooltip', 'title' => __('Delete'), 'class' => "btn btn-default"), array('Are you sure?')); ?></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
