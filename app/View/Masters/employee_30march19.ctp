...
<!--                                        <input type="radio" value="Y" name="usercreate_flagY" id="usercreate_flagY"   <?php if ($usercreate['employee']['usercreate_flag'] == 'Y') { ?> checked <?php } ?>>Yes
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                ...
                                <div  class="rowht"></div>
                                <div class="row">
                                    <div id='divitr' hidden="true" class="form-group">
                                        <label for="divitr" class="col-sm-3 control-label"><?php echo __('ITR Number'); ?>:</label>    
                                        <div class="col-sm-3">
                                            <?php echo $this->Form->input('itr_number', array('label' => false, 'id' => 'itr_number', 'type' => 'text', 'class' => 'form-control input-sm')); ?>
                                            <span id="itr_number_error" class="form-error"><?php //echo $errarr['biometric_capture_flag_error'];                       ?></span>
                                        </div>
                                    </div>
                                </div>
    ...
    <input type='hidden' value='<?php echo $hfpwd; ?>' name='hfpwd' id='hfpwd'/>
</div>
