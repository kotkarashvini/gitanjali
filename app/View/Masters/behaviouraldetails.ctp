...
<script>
    $(document).ready(function () {
        ...
        if (actiontype == '2') {
            $('.tdsave').show();
            $('.tdselect').hide();
            $('#behavioral_details_desc_en').focus();
        }
    });
</script>
...
<script>
    ...
    function formupdate(behavioral_id,
<?php
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    <a  href="<?php echo $this->webroot; ?>helpfiles/Behaviouraldetails/behaviouraldetails_<?php echo $laug; ?>.html" class="btn btn-small btn-info" target="_blank"> <i class="fa fa-info-circle"></i>  <?php echo __('Help'); ?> </a>
                </div> 
            </div>
            <div class="box-body">
                <div class="row">
                        ...
                        <tbody>
                            <?php foreach ($behaviouraldetailsrecord as $behaviouraldetailsrecord1): ?>
                                <tr>
                                    ...
                                    <td >
                                        <button id="btnupdate" name="btnupdate" type="button" data-toggle="tooltip" title="Edit" class="btn btn-default "   onclick="javascript: return formupdate(('<?php echo $behaviouraldetailsrecord1['0']['behavioral_id']; ?>'),
                                        <?php
                                        foreach ($languagelist as $langcode) {
                                            // pr($langcode);
                                            ?>
