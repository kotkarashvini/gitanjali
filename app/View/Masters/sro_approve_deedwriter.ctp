      ...
      function activate_advocate(id)
    {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data == 1)
                {
                    alert('Advocate is Accepted.');
                    window.location.reload();
                    return false;
                }
                else {
                    alert('Advocate is not Accepted.Please try again.');
                }
            }
        });
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($advocate[$i][0]['is_advocate_accept_flag'] == 'N') { ?>
                                    <button id="active" class="btn btn-primary" onClick="activate_advocate(<?php echo $advocate[$i][0]['id'] ?>);">Accept</button>
                                <?php } else { ?>
                                    <button id="deactive" class="btn btn-primary" onClick="deactivate_advocate(<?php echo $advocate[$i][0]['id'] ?>);">Reject</button>
                                <?php } ?>
                            </td>
                        </tr>
                    <?php } ?>
