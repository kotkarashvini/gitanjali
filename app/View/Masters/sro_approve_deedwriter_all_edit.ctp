...
<script language="JavaScript" type="text/javascript">
    $(document).ready(function () {
        ...
        $("#deed_writer").change(function () {
            if (this.checked) {

                $('#lbl_deed_writer_off').show();
                $('#deed_office').show();
...
<?php } ?>
    ...
    function check_unique_update_mail() {
//alert($('#user_id').val());
        ...
        if (email != '') {
            $.ajax({
                type: "POST",
                url: "<?php echo $this->webroot; ?>/Users/checkuniqueemail",
                data: {'email': email, user_id: $('#user_id').val()},
                success: function (data) {
                    if (data == 1)
                    {
                        $("#email_id").val('');
    ...
    function check_unique_update_mobile() {
        var mobile = $('#mobile_no').val();
        //alert(mobile);return false;
        if (mobile != '') {
            $.ajax({
                type: "POST",
                url: "<?php echo $this->webroot; ?>/Users/checkuniquemobile",
                data: {'mobile': mobile, user_id: $('#user_id').val()},
                success: function (data) {
    ...
    function check_unique_update_uid() {
        var uid = $('#uid').val();
        if (uid != '') {
            $.ajax({
                type: "POST",
                url: "<?php echo $this->webroot; ?>/Users/checkuniqueuid",
                data: {'uid': uid, user_id: $('#user_id').val()},
                success: function (data) {
    ...
    <div class="col-lg-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <!--                <div class="box-body">
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <label for="contact_person" class="col-sm-2 control-label" id='lbldeed_writer'><?php echo __('Is Deed Writer?'); ?></label>  
                                            <div class="col-sm-2"> <?php echo $this->Form->input('deed_writer', array('type' => 'checkbox', 'value' => 'Y', 'label' => false, 'div' => false, 'id' => 'deed_writer')); ?></div>                            
                ...
                <?php
                if (isset($demo1)) {
                    echo $this->Form->input('reg_id', array('label' => false, 'id' => 'reg_id', 'type' => 'hidden', 'value' => $demo1['reg_id']));
                }
                ?>
                ...
                // pr($demo1);exit;
                if (isset($demo1)) {
                    echo $this->Form->input('user_id', array('label' => false, 'id' => 'user_id', 'type' => 'hidden', 'value' => $demo1['user_id']));
                }
                ?>
                <div class="box box-primary">
                    <div class="box-body">
        ...
        <!--                        <label for="Division" class="col-sm-3 control-label"><?php echo __('lbladmdivision'); ?></label>    
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <?php echo $this->Form->input('taluka_id', array('label' => false, 'id' => 'taluka_id', 'class' => 'form-control input-sm', 'empty' => '--Select Taluka--', 'options' => array($taluka))); ?>
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3" id="deed_office">
                                    <?php echo $this->Form->input('office_id', array('label' => false, 'id' => 'office_id', 'class' => 'form-control input-sm', 'empty' => '--Select Office--', 'options' => array($office))); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="box-body" id="nri_details">
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <?php echo $this->Form->input('address', array('label' => false, 'id' => 'address', 'type' => 'text', 'class' => 'form-control', 'maxlength' => '100')); ?>
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <?php echo $this->Form->input('email_id', array('label' => false, 'id' => 'email_id', 'type' => 'text', 'class' => 'form-control', 'onblur' => 'check_unique_update_mail()', 'maxlength' => '25')); ?>
                                ...
                                <div class="col-sm-3">
                                    <?php echo $this->Form->input('mobile_no', array('label' => false, 'id' => 'mobile_no', 'type' => 'tel', 'class' => 'form-control', 'onblur' => 'check_unique_update_mobile()', 'maxlength' => '10')); ?>
                        ...
                        <div class="row" id="uiddiv">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3" id="pantxt">
                                    <?php echo $this->Form->input('uid', array('label' => false, 'id' => 'uid', 'type' => 'password', 'class' => 'form-control ', 'onblur' => 'check_unique_update_uid()', 'maxlength' => '12', 'readonly', 'onfocus' => '$(this).removeAttr("readonly");')); ?>
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <?php echo $this->Form->input('user_name', array('label' => false, 'id' => 'user_name', 'type' => 'text', 'readonly', 'class' => 'form-control', 'maxlength' => '50')); ?>
