...
//    }
    function get_unitmapping_records() {
        $.post('<?php echo $this->webroot;?>Masters/get_unitmapping_records', { usagemain: $('#usage_main_catg_id').val(), usagesub: $('#usage_sub_catg_id').val(),usage_param_id: $('#usage_param_id').val()}, function (response) {
        $('#unitlisttbl').html('');
