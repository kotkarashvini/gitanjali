                              ...
                              ?>
                                <li>
                                    <a href="#">                                       
                                        <span class="fa fa-hand-o-right"></span>
                                           <?php
                                          $newid=$c[0]['case_type_id'];
//                                          pr($newid);
                                          
                                            $casetitle = "";
                                            $casetitle.=$c[0]['case_type_desc']."-".$c[0]['count'];
//                                            foreach($dataid as $case_id){
//                                                pr($case_id);exit;
                                            echo $this->Html->link($casetitle, '/NewCase/genernal_info/' . $newid);
...
//                                            ));
                                          $newid=$c[0]['office_id'];
                                            $casetitle = "";
                                            $casetitle.=$c[0]['office_name_en']."-".$c[0]['count'];
                                            echo $this->Html->link($casetitle, '/NewCase/proceeding_details/' . $newid);
//                                            echo $this->Html->image('new.gif', array('border' => '0'));
                                            ?>
                                    </a>
