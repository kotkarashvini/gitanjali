...
<script>
    ...
    function forupdate(id, village_name_en, level_1_desc_en, list_1_desc_en, district_id, taluka_id, village_id, developed_land_types_id,
    ulb_type_id, corp_id, level1_id, level1_list_id, lr_code, usage_main_catg_id, usage_sub_catg_id, segment_no, prop_unit, prop_rate) {
...
//            $.getJSON("get_corp_list", {corp: ulb_type_id,dist: district_id}, function (data)
//            {
//                var sc = '<option value="">--Select--</option>';
//                $.each(data, function (index, val) {
//                    sc += "<option value=" + index + ">" + val + "</option>";
...
//            });
        ...
        $('#hfvillage').val(village_id);
        $('#hflevel1').val(level1_id);
        $('#hflevellist1').val(level1_list_id);
