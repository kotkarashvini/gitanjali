...
//        })
    ...
    function formadd() {
                    ...
                    var result1 = confirm("Do you Really want to Upadate this Record ??????????");
                    if (result1) {
                        $('#rate').submit();
                    } else {
                        return false;
    ...
    function taluka_change_event() {
        ...
        $.post("rategrid_update", {district: district, taluka: taluka}, function (data)
        {
            $("#divrategrid").html(data);
        });
    }
...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <center><h3 class="box-title" style="font-weight: bolder"><?php echo __('Property Rate Upadate'); ?></h3></center>
            ...
            <div class="box-body">
                ...
                <div id="divrategrid" class="table-responsive"></div>
            </div>
        </div>
    </div>
    ...
    <input type='hidden' value='<?php echo $hflevel1; ?>' name='hflevel1' id='hflevel1'/>
    <input type='hidden' value='<?php echo $hflevellist1; ?>' name='hflevellist1' id='hflevellist1'/>
</div>
