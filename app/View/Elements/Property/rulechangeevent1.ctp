                    ...
                    <div class="col-md-12 pad">
                        ...
                        <div class="col-md-2" >
                            ...
                            if ($usageitemlist1['itemlist']['is_list_field_flag'] == 'Y') {
                                ...
                                echo $this->Form->input($usageitemlist1['usagelinkcategory']['uasge_param_code'] . "_" . $usageitemlist1['usagelinkcategory']['evalrule_id'], array('type' => 'select', 'error' => false, 'options' => $itemlistoptions, 'id' => $usageitemlist1['usagelinkcategory']['uasge_param_code'] . "_" . $usageitemlist1['usagelinkcategory']['evalrule_id'], 'label' => false, 'class' => 'form-control input-sm usage-input-fields'));
                            } else {
                                if (isset($defaultval_flag)) {
