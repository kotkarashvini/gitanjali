...
<?php echo $this->Form->create('loclevellist1', array('id' => 'loclevellist1', 'autocomplete' => 'off')); ?>
<div class="row">
    <div class="col-lg-12">
        
        <div class="box box-primary">
            <div class="box-header with-border">
                <center><h3 class="box-title headbolder"><?php echo __('lbllocationlevellist1'); ?></h3></center>
                <div class="box-tools pull-right">
                    <a  href="<?php echo $this->webroot; ?>helpfiles/Village/level1list_<?php echo $laug; ?>.html" class="btn btn-small btn-info" target="_blank"> <i class="fa fa-info-circle"></i>  <?php echo __('Help'); ?> </a>
                </div> 
            </div>
            <div class="box-body">
                <div class="col-md-12">
...
<!--                     <div class="col-md-2 ">
                    ...
                    <div class="col-md-2 ">
                          <label for="level_1_id" class="control-label"><?php echo __('lblLevel1'); ?><span style="color: #ff0000">*</span> </label>
                            <?php echo $this->Form->input('level_1_id', array('options' => $level1data, 'empty' => '--select--', 'id' => 'level_1_id', 'class' => 'form-control input-sm chosen-select', 'label' => false)); ?>
                            <span class="form-error" id="level_1_id_error"></span>
                    </div>
...
//  creating dyanamic text boxes using same array of config language
                    foreach ($languagelist as $key => $langcode) {
                        ?>
                        <div class="col-md-2">
                            <label><?php echo __('lblloclevellist1desc') . "  " . $langcode['mainlanguage']['language_name']; ?><span style="color: #ff0000">*</span></label>    
                            <?php echo $this->Form->input('list_1_desc_' . $langcode['mainlanguage']['language_code'], array('label' => false, 'id' => 'list_1_desc_' . $langcode['mainlanguage']['language_code'], 'class' => 'form-control input-sm', 'type' => 'text', 'maxlength' => '100')) ?>
                            <span id="<?php echo 'list_1_desc_' . $langcode['mainlanguage']['language_code'] . '_error'; ?>" class="form-error"><?php //echo $errarr['village_name_' . $langcode['mainlanguage']['language_code'] . '_error'];                              ?></span>
                ...
                <?php
                echo $this->Form->input('prop_level1_list_id', array('label' => false, 'id' => 'prop_level1_list_id', 'type' => 'hidden'));
                ?>
                ...
                <div class="row center">
                    <div class="form-group">
                        <div class="col-sm-12 tdselect">
                            ...
                            <a href="<?php echo $this->webroot; ?>BlockLevels/loclevellist1" class="btn btn-info "><?php echo __('btncancel'); ?></a>
...
<!--                        <tr>  <th class="center width10"><?php //echo __('lbllocationlevel1'); ?></th>
-->                            <th class="center"><?php echo __('lbladmvillage'); ?></th>
                            <th class="center"><?php echo __('lblLevel1'); ?></th>   
                            <?php
                            foreach ($languagelist as $langcode) {
                                ?>
                                <th class="center"><?php echo __('lblloclevellist1desc') . "  " . $langcode['mainlanguage']['language_name']; ?></th>
                            <?php } ?>
                    ...
                    <tbody>
                        ...
                        <?php
                        // pr($loclevellist1data);
                        foreach ($loclevellist1data as $loclevellist1data1) {
                            ?>
                            <tr>
                                <td class="tblbigdata"><?php echo $loclevellist1data1[0]['village_name_en']; ?></td>
                                <td class="tblbigdata"><?php echo $loclevellist1data1[0]['level_1_desc_en']; ?></td>
                                ...
                                foreach ($languagelist as $langcode) {
                                    ?>
                                    <td ><?php echo $loclevellist1data1[0]['list_1_desc_' . $langcode['mainlanguage']['language_code']]; ?></td>
                                <?php } ?>
                                ...
                                <td>
                                    ...
                                    <a <?php echo $this->Html->Link($this->Html->tag('span', '', array('class' => 'fa fa-pencil')), array('action' => 'loclevellist1', $loclevellist1data1[0]['prop_level1_list_id']), array('escape' => false, 'data-toggle' => 'tooltip', 'title' => __('Edit'), 'class' => "btn-sm btn-success"), array('Are you sure to Edit?')); ?></a>
                                    <a <?php echo $this->Html->Link($this->Html->tag('span', '', array('class' => 'fa fa-remove')), array('action' => 'loclevellist1_delete', $loclevellist1data1[0]['prop_level1_list_id']), array('escape' => false, 'data-toggle' => 'tooltip', 'title' => __('Delete'), 'class' => "btn-sm btn-danger"), array('Are you sure to Delete?')); ?></a>
                                </td>  </tr> 
                        <?php } ?>
