        ...
        <div class="col-lg-12">
            <div class="box box-primary">
                <div class="box-header with-border">                         
                    <h4> <?php echo $this->html->link('Download PDF', array('controller' => 'LegacyReportsummary', 'action' => 'legacy_report', $doc_token_no, 'D')); ?> </h4>
                    ...
                    <?php
                    //echo $design;
                    $result = $this->requestAction(array('controller' => 'LegacyReportsummary', 'action' => 'legacy_report', $doc_token_no, 'V'));
                    echo $result;
                    ?>
                </div>   
