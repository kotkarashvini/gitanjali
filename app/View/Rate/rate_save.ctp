...
//        })
    ...
    function formadd() {
        ...
        {
            if (data == 'Y') {
                var result = confirm("The Mauza Name " + village + " is Alerady Exist in " + talukaname + " Anchal...!!! \n\
    \n\
Please confirm Governing Body and List..!!!\n\
    ...
    Do you really want add this Village Name ??????");
                if (result) {
                    ...
                    var result1 = confirm("Please Reconfirm...!!!  Do you really want add this Mauza Name ??????");
                    if (result1) {
                        $('#rate').submit();
                    } else {
                        return false;
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                    ...
                    <table id="" class="table table-striped table-bordered table-hover">  
                        <thead >  
                            <tr>  
                                ...
                                <th class="center"><?php echo __('lbladmvillage'); ?>(LOCAL)</th>
                                <th class="center"><?php echo __('lblLevel1'); ?></th>
                                 <th class="center"><?php echo __('lblLevel1'); ?>(LOCAL)</th>
                                <th class="center"><?php echo __('lblLevel1list'); ?></th>
                                <th class="center"><?php echo __('lblLevel1list'); ?>(LOCAL)</th>
                                <?php if($stateid == 20){ ?>
                        ...
                        <tbody>
                            <tr>  
                                ...
                                <td class="tblbigdata"><?php echo $this->Form->input('village_name_ll', array('label' => false, 'id' => 'village_name_ll', 'class' => 'form-control input-sm', 'type' => 'text')) ?>
                                    <span id="village_name_en_error" class="form-error"><?php //echo $errarr['village_name_en_error'];     ?></span>
                                ...
                                <td class="tblbigdata"><?php echo $this->Form->input('level_1_desc_en', array('label' => false, 'id' => 'level_1_desc_en', 'class' => 'form-control input-sm', 'type' => 'text')) ?>
                                 ...
                                 <td class="tblbigdata"><?php echo $this->Form->input('level_1_desc_ll', array('label' => false, 'id' => 'level_1_desc_ll', 'class' => 'form-control input-sm', 'type' => 'text')) ?>
                                    <span id="level_1_desc_en_error" class="form-error"><?php //echo $errarr['level_1_desc_en_error'];     ?></span>
                                ...
                                <td class="tblbigdata"><?php echo $this->Form->input('list_1_desc_ll', array('label' => false, 'id' => 'list_1_desc_ll', 'class' => 'form-control input-sm', 'type' => 'text')) ?>
                                    <span id="list_1_desc_en_error" class="form-error"><?php //echo $errarr['list_1_desc_en_error'];     ?></span>

                                </td>
                                <?php if($stateid == 20){ ?>
                                <td class="tblbigdata"><?php echo $this->Form->input('mauja_code', array('label' => false, 'id' => 'mauja_code', 'class' => 'form-control input-sm', 'type' => 'text')) ?>
                                    <span id="mauja_code_error" class="form-error"><?php //echo $errarr['lr_code_error'];     ?></span>
                                </td>
                                <?php } else { ?>
                ...
                <div id="" class="table-responsive">
                    <table id="" class="table table-striped table-bordered table-hover">  
                        <thead >  
                            <tr> <?php if($stateid == 20){ ?>
                                <th class="center"><?php echo __('Ward No'); ?></th>
                                <?php } else { ?>
                                <th class="center"><?php echo __('Segment No'); ?></th>
                                <th class="center"><?php echo __('Hadbast No'); ?></th>
                                <?php }  ?> 
                                <th class="center"><?php echo __('LG Code'); ?></th>
                        ...
                        <tbody>
                            <tr><?php if($stateid == 20){ ?>
                                <td class="tblbigdata"><?php echo $this->Form->input('word_no', array('label' => false, 'id' => 'word_no', 'class' => 'form-control input-sm', 'type' => 'text')) ?>
                                    <span id="word_no_error" class="form-error"><?php //echo $errarr['segment_no_error'];     ?></span>
                                </td>
                                <?php } else { ?>
                               <td class="tblbigdata"><?php echo $this->Form->input('segment_no', array('label' => false, 'id' => 'segment_no', 'class' => 'form-control input-sm', 'type' => 'text')) ?>
                                ...
                                <td class="tblbigdata"><?php echo $this->Form->input('hadbast_no', array('label' => false, 'id' => 'hadbast_no', 'class' => 'form-control input-sm', 'type' => 'text')) ?>
                                    <span id="hadbast_no_error" class="form-error"><?php //echo $errarr['segment_no_error'];     ?></span>
                                </td>
                                <?php }  ?> 
                                <td class="tblbigdata"><?php echo $this->Form->input('lg_code', array('label' => false, 'id' => 'lg_code', 'class' => 'form-control input-sm', 'type' => 'text')) ?>
                                    <span id="lg_code_error" class="form-error"><?php //echo $errarr['segment_no_error'];     ?></span>
                                </td>
                                ...
                                <td class="tblbigdata"><?php echo $this->Form->input('usage_sub_catg_id', array('label' => false, 'id' => 'usage_sub_catg_id', 'class' => 'form-control input-sm', 'type' => 'select')) ?>
                                 ...
                                 <?php if($stateid == 20){ ?>
                                <td class="tblbigdata"><?php echo $this->Form->input('construction_type_id', array('label' => false, 'id' => 'construction_type_id', 'class' => 'form-control input-sm', 'empty' => 'NOT APPLICABLE', 'type' => 'select', 'options' => $constuctiontype)) ?>
                                    <!--<span id="construction_type_id_error" class="form-error"><?php //echo $errarr['usage_main_catg_id_error'];     ?></span>-->
                                </td>
                                <?php } ?>
