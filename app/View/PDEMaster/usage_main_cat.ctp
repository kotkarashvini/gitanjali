                ...
                <div class="form-group">
                    ...
                    foreach ($languagelist as $key => $langcode) {
                        ...
                        <div class="col-md-3">
                            ...
                            <?php echo $this->Form->input('usage_main_catg_desc_' . $langcode['mainlanguage']['language_code'], array('label' => false, 'id' => 'usage_main_catg_desc_' . $langcode['mainlanguage']['language_code'], 'class' => 'form-control input-sm', 'type' => 'text', 'maxlength' => '100')) ?>
                ...
                <div class="row center">
                    <div class="form-group">
                        <div class="col-sm-12 tdselect">
                            ...
                            <a href="<?php echo $this->webroot; ?>PDEMaster/usage_main_cat" class="btn btn-info "><?php echo __('btncancel'); ?></a>
                    ...
                    <tbody>
                        ...
                        foreach ($MainCat as $MainCat1) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a <?php echo $this->Html->Link($this->Html->tag('span', '', array('class' => 'fa fa-pencil')), array('action' => 'usage_main_cat', $MainCat1[0]['usage_main_catg_id']), array('escape' => false, 'data-toggle' => 'tooltip', 'title' => __('Edit'), 'class' => "btn-sm btn-default"), array('Are you sure to Edit?')); ?></a>
                                    <a <?php echo $this->Html->Link($this->Html->tag('span', '', array('class' => 'fa fa-remove')), array('action' => 'delete_usage_main_cat', $MainCat1[0]['usage_main_catg_id']), array('escape' => false, 'data-toggle' => 'tooltip', 'title' => __('Delete'), 'class' => "btn-sm btn-default"), array('Are you sure?')); ?></a>
                                </td>  
                            </tr> 
                        <?php } ?>
