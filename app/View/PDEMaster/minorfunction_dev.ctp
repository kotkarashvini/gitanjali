    ...
    <div class="col-lg-12">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <center><h3 class="box-title headbolder"><?php echo __('lblminorfunctionentry'); ?></h3></center>
                <div class="box-tools pull-right">
                    <a  href="<?php echo $this->webroot; ?>helpfiles/admin/PDEfunctionentry_<?php echo $lang; ?>.html" class="btn btn-small btn-info" target="_blank"> <i class="fa fa-info-circle"></i>  <?php echo __('Help'); ?> </a>
                </div> 
            ...
            <div class="box-body">
                <div class="row" id="selectminorfunction">
                    <div class="col-md-12">
                        <div class="col-sm-3">
                            <label for="mf_id" class=" control-label"><?php echo __('lblfunctionid'); ?><span style="color: #ff0000">*</span></label>
                            <?php echo $this->Form->input('id', array('label' => false, 'id' => 'id', 'class' => 'form-control input-sm', 'type' => 'text','maxlength' => '20')); ?>
                            <span id="id_error" class="form-error"></span>
                        </div>
                        <div class="col-sm-3">
                            <label for="mf_id" class=" control-label"><?php echo __('lblminorfunction'); ?><span style="color: #ff0000">*</span></label>
                            <?php echo $this->Form->input('function_desc', array('label' => false, 'id' => 'function_desc', 'class' => 'form-control input-sm', 'type' => 'text','maxlength' => '20')); ?>
                            <span id="function_desc_error" class="form-error"></span>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">                       
                        ...
                        <div class="col-md-3">
                            ...
                            echo $this->Form->input('action', array('label' => false, 'id' => 'action',
                                ...
                                'maxlength' => '20'))
                            ?>
                            <span id="<?php echo 'action' . '_error'; ?>" class="form-error">       </span>
                        </div> 
                ...
                <div class="row">
                    <div class="col-md-12"> 
                        <div class="col-md-3">
                            ...
                            <span id="dispaly_flag_error" class="form-error">       </span>
                        </div>   
                        <div class="col-md-3">
                            <label>
                ...
                <div class="row">
                    <div class="col-md-12"> 
                        ...
                        <div class="col-md-3">
                            ...
                            <span id="sro_menu_flag_error" class="form-error">       </span>
                        </div>  
                        <div class="col-md-3">
                            <label>
                ...
                <div class="row">
                    <div class="col-md-12"> 
                        ...
                        <div class="col-md-3">
                            ...
                            <span id="e_reg_menu_error" class="form-error">       </span>
                        </div>  
                        ...
                        <div class="col-md-3">
                            ...
                            <span id="e_filing_flag_error" class="form-error">       </span>
                        </div>  
                        ...
                        <div class="col-md-3">
                            ...
                            <span id="leave_licence_flag_error" class="form-error">       </span>
                        </div> 
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-3">
                            ...
                            <span id="cidco_citizen_flag_error" class="form-error">       </span>
                        </div> 
                ...
                <div class="row center" >
                    <div class="form-group" >
                        ...
                        <a href="<?php echo $this->webroot; ?>PDEMaster/minorfunction_dev" class="btn btn-info "><?php echo __('btncancel'); ?></a>
                        ...
                        <tbody>
                            <?php foreach ($minorfunction as $minorfunction1): ?>
                                <tr>     
                                    ...
                                    <td>
                                         <?php echo $this->Html->Link($this->Html->tag('span', '', array('class' => 'glyphicon glyphicon-pencil')), array('action' => 'minorfunction_dev', $minorfunction1['minorfunction']['minor_id']), array('escape' => false, 'data-toggle' => 'tooltip', 'title' => __('Edit'), 'class' => "btn btn-success"), array('Are you sure to Edit?')); ?>

                                       <!-- <?php echo $this->Html->Link($this->Html->tag('span', '', array('class' => 'glyphicon glyphicon-remove')), array('action' => 'delete_minorfunction_dev', $minorfunction1['minorfunction']['minor_id']), array('escape' => false, 'data-toggle' => 'tooltip', 'title' => __('Delete'), 'class' => "btn btn-danger"), array('Are you sure to Delete?')); ?>-->
                                    </td>
