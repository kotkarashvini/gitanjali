...
<div class="row">
 ...
 <div class="note">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <label for="minorfun_id" class="col-sm-2 control-label"><?php echo __('lblminorfunction'); ?><span style="color: #ff0000">*</span></label> 
                        <div class="col-sm-2">
		  ...
		  <a href="<?php echo $this->webroot; ?>PDEMaster/article_screen_mapping" class="btn btn-info "><?php echo __('btncancel'); ?></a>
                ...
                <table id="tablearticlescreen" class="table table-striped table-bordered table-hover">  
                    <thead >  
                        <tr>  
                            ...
                            <th class="center"><?php echo __('lblminorfunction'); ?></th>
                        ...
                        <?php foreach ($articlegrid as $articlegrid1): ?>
                            <tr>
                                ...
                                <td >
                                   ...
                                   <?php echo $this->Html->Link($this->Html->tag('span', '', array('class' => 'glyphicon glyphicon-remove')), array('action' => 'article_screen_mapping_delete', $articlegrid1[0]['id']), array('escape' => false, 'data-toggle' => 'tooltip', 'title' => __('Delete'), 'class' => "btn btn-danger"), array('Are you sure to delete?')); ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
