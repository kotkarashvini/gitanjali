            ...
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3 " >
                            <?php echo $this->Form->input('presentation_no', array('label' => false, 'class' => 'form-control', 'id' => 'presentation_no', 'placeholder' => '','maxlength'=>"15")); ?>
            ...
            <div class="box-body">
                ...
                <div class="row">
                    ...
                    <!-- <div class="col-sm-3 right-border" >
                        ...
                        <label for="" class="col-sm-3 control-label"><?php echo __('book No'); ?><span style="color: #ff0000">*</span></label> 
                        <div class="col-sm-3 right-border" >
                        ...
                        <label for="" class="col-sm-3 control-label"><?php echo __('Deed No'); ?><span style="color: #ff0000">*</span></label> 
                        <div class="col-sm-3 right-border" >
