...
<?php echo $this->Form->create('frmparty', array('id' => 'frmparty', 'autocomplete' => 'off')); ?> 

<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-success">
            <div class="panel-heading" style="text-align: center"><b><?php echo __('lblpartydetails'); ?></b></div>
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <?php foreach ($minorfunction as $mf) { ?>
                                                             <input type="button" id="btn<?php echo $mf['minorfunction']['function_desc']; ?>" class="btn btn-primary" style="width: 100px;" value="<?php echo __($mf['formlabels']['labelname']); ?>"  onclick="location.href = '<?php echo $this->Html->url(array('controller' => 'Property', 'action' => $mf['mf_forms']['form_name'])); ?>';" />
                            <?php } ?>
                                    </div>-->
                            <br>
