...
//                $('#party_type_id').val('');
        ...
        $('#article_id').change(function () {
            ...
            $.getJSON('<?php echo $this->webroot; ?>GASearch/get_party_type', {article_id: article_id}, function (data)
            {
        ...
        $('#taluka_id').change(function () {
            ...
            $.getJSON('<?php echo $this->webroot; ?>GASearch/get_village', {taluka_id: taluka_id}, function (data)
            {
                var sc = '<option value="">--Select--</option>';
                $.each(data, function (index, val) {
                    sc += "<option value=" + index + ">" + val + "</option>";
...
//        var to = $('#hftoyear').val();
//        $.post('<?php echo $this->webroot; ?>GASearch/rptnonemcomb_copy', {token_no: token_no, from: from, to: to}, function (data)
//        {
//            $("#rptdetails").html('');
//            $("#downdeed").html('');
//            $('#btnpay').hide();
...
//             $('#myModal').modal('show');
    ...
    function details(token_no, flag) {
        var from = $('#hffromyear').val();
        var to = $('#hftoyear').val();
        $.post('<?php echo $this->webroot; ?>GASearch/rptdetails', {token_no: token_no, from: from, to: to, flag: flag}, function (data)
        {
            $("#rptdetails").html('');
            $("#downdeed").html('');
            $('#btnpay').hide();
...
//             $('#myModal').modal('show');
    ...
    function Certifiedcopy(token_no) {
        $.post('<?php echo $this->webroot; ?>GASearch/fee_receipt', {token_no: token_no}, function (data)
        {
            ...
            <div class="box-body"><BR>
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <?php echo $this->Html->link('Change Search Years', array('controller' => 'GASearch', 'action' => 'searchindex'), array('escape' => false)); ?>
                                    ...
                                    <td class="width10 center">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                ...
                                                <li class="divider"></li>
                                                <li> <?php
                                                    $scan_upload = $this->requestAction(array('controller' => 'GASearch', 'action' => 'getscandata', $partygrid1[0]['token_no']));
                                                    if (!empty($scan_upload)) {
                                                        echo $this->Html->link(
                                                                __('Inspection Copy'), array(
                                                            'disabled' => TRUE,
                                                            'controller' => 'GASearch', // controller name
                                    ...
                                    <td class="width10 center">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                ...
                                                <li class="divider"></li>
                                                <li> <?php
                                                    $scan_upload = $this->requestAction(array('controller' => 'GASearch', 'action' => 'getscandata', $propertygrid1[0]['token_no']));
                                                    if (!empty($scan_upload)) {
                                                        echo $this->Html->link(
                                                                __('Inspection Copy'), array(
                                                            'disabled' => TRUE,
...
<!--                                                <li class="divider"></li>
                                    ...
                                    <td >  <?php
                                        $result = $this->requestAction(array('controller' => 'GASearch', 'action' => 'propertydata', $propertygrid1[0]['token_no']));
                                        echo $result;
                                        ?> </td>
                        ...
                        <tbody>
                            <?php foreach ($deedgrid as $deedgrid1): ?>
                                <tr>
                                    <td class="width10 center">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                ...
                                                <li class="divider"></li>
                                                <li> <?php
                                                    $scan_upload = $this->requestAction(array('controller' => 'GASearch', 'action' => 'getscandata', $deedgrid1[0]['token_no']));
                                                    if (!empty($scan_upload)) {
                                                        echo $this->Html->link(
                                                                __('Inspection Copy'), array(
                                                            'disabled' => TRUE,
                                    ...
                                    <td >  <?php
                                        $result = $this->requestAction(array('controller' => 'GASearch', 'action' => 'propertydata', $deedgrid1[0]['token_no']));
                                        echo $result;
                                        ?> </td>
