...
//---------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    function editSubrule(id, out_id, out_order, max_flag, rate_rev_flag, f1, c1, f2, c2, f3, c3, f4, c4, f5, c5, mf, af, rf1, rf2, rf3, rf4, rf5) {
...
<div class="box box-primary">
    <div class="box-header with-border">
          <a  href="<?php echo $this->webroot;?>helpfiles/ValuationRules/valuation_sub_rule_<?php echo $lang; ?>.html" class="btn btn-default pull-right " target="_blank"> <?php echo  __('help');?> <span class="fa fa-question fa-circle-o"></span></a>
        ...
        <div class="col-sm-12">
            <div class="col-sm-7">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">                            
                            <label for="Output Item" class="control-label col-sm-3"><?php echo __('lbloutputitem'); ?> <span style="color:red">*</span></label>                            
                            <div class="col-sm-5" >
                                <?php echo $this->Form->input($name[14], array('id' => 'output_item_id', 'options' => $outitemlist, 'empty' => '--Select Option--', 'label' => false, 'class' => 'form-control input-sm', 'required')); ?>
                                <span id="output_item_id_error" class="form-error"><?php echo $errarr['output_item_id_error']; ?></span>
                            </div>                            
                            <div id="subrule_ouder">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <span id="out_item_order_error" class="form-error"><?php echo $errarr['out_item_order_error']; ?></span>
                                </div>                            
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9" style="height: 100px;overflow-y: scroll;padding-left: 0px; border: 2px #00529B ridge" id="paradescid">
                                <ul style="list-style: none">
                                    <?php
                                    foreach ($inputlist as $itemcode => $listItem) {
                                        echo '<li>' . $itemcode . ' : ' . $listItem . '</li>';
                                    }
                                    ?>
                                </ul>
                            </div>
    ...
    <div class="row" id="roadvicinityrow">
        <div class="col-sm-12">
            <div class="form-group">
                <label for="Road Vicinity Id" class="control-label col-sm-3"><?php echo __('lblroadvicinity'); ?></label>
                <div class="col-sm-4" >
                    <?php echo $this->Form->input($name[17], array('options' => $roadvicinitylist, 'empty' => '--Select--', 'id' => 'roadvicinityid', 'label' => false, 'class' => 'form-control input-sm')); ?>
                    <span id="roadvicinityid_error" class="form-error"><?php //echo $errarr['roadvicinityid_error'];            ?></span>
                </div>           
            </div>
        </div>
    </div>
    ...
    <div class="row" id="userdependancy1row">
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <div class="col-sm-4" >
                    <?php echo $this->Form->input($name[18], array('options' => $userdd1list, 'empty' => '--Select--', 'id' => 'userdefineddependency1', 'label' => false, 'class' => 'form-control input-sm')); ?>
                    <span id="userdefineddependency1_error" class="form-error"><?php //echo $errarr['userdefineddependency1_error'];           ?></span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row" id="userdependancy2row">
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <div class="col-sm-4" ><?php echo $this->Form->input($name[19], array('options' => $userdd2list, 'empty' => '--Select--', 'id' => 'userdefineddependency2', 'label' => false, 'class' => 'form-control input-sm')); ?>
                    <span id="userdefineddependency2_error" class="form-error"><?php //echo $errarr['userdefineddependency2_error'];          ?></span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <div class="col-sm-3"> <?php echo $this->Form->input($name[13], array('type' => 'radio', 'options' => array('Y' => '&nbsp;Yes&nbsp;&nbsp;&nbsp;&nbsp;', 'N' => '&nbsp;No'), 'value' => 'N', 'legend' => false, 'div' => false, 'class' => 'select', 'id' => 'max_value_condition_flag')); ?>
                    <span id="max_value_condition_flag_error" class="form-error"><?php //echo $errarr['max_value_condition_flag_error'];         ?></span>
                </div> 
            </div>
        </div>
    </div>                     
                ...
                <div class="col-sm-12">
                    <div class="form-group">    
                        ...
                        <div class="col-sm-4"><?php echo $this->Form->input($name[12], array('id' => 'max_value_formula', 'placeholder' => 'Max Value Formula', 'label' => false, 'class' => 'cndpr form-control input-sm')); ?>
                            <span id="max_value_formula_error" class="form-error"><?php //echo $errarr['max_value_formula_error'];       ?></span>
                        </div>
        ...
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <div class="col-sm-3"> <?php echo $this->Form->input($name[39], array('type' => 'radio', 'options' => array('Y' => '&nbsp;Yes&nbsp;&nbsp;&nbsp;&nbsp;', 'N' => '&nbsp;No'), 'value' => 'N', 'legend' => false, 'div' => false, 'class' => 'select', 'id' => 'rate_revision_flag')); ?>
                    <span id="rate_revision_flag_error" class="form-error"><?php //echo $errarr['rate_revision_flag_error'];      ?></span>
                </div> 
            </div>
        </div>
    </div>
    ...
    <div class="row top-buffer">
        <div class="col-sm-12">
            <div class="form-group">
                ...
                <div class="col-sm-4"><?php echo $this->Form->input('parameterlist', array('type' => 'select', 'empty' => '-select-', 'options' => $inputlist, 'multiple' => false, 'label' => false, 'class' => 'form-control input-sm', 'id' => 'parameter_id')); ?></div>
                <label for="Select Operator" class="control-label col-sm-2"><?php echo __('lblselectoperator'); ?></label>                        
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <div class="col-sm-4">
                                ...
                                <span id="evalsubrule_cond1_error" class="form-error"><?php echo $errarr['evalsubrule_cond1_error']; ?></span>
                            </div>
                            <div class="col-sm-4 ">
                                ...
                                <span id="rate_revision_formula1_error" class="form-error"><?php echo $errarr['rate_revision_formula1_error']; ?></span>
                            </div>                                                       
                            <div class="col-sm-4">
                                <?php echo $this->Form->input($name[4], array('id' => 'evalsubrule_formula1', 'placeholder' => 'Formula 1', 'required', 'data-cndpr' => 'Y', 'label' => false, 'class' => 'cndpr form-control input-sm')); ?>
                                <span id="evalsubrule_formula1_error" class="form-error"><?php echo $errarr['evalsubrule_formula1_error']; ?></span>
                            </div>                                                       
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <div class="col-sm-4">
                                ...
                                <span id="evalsubrule_cond2_error" class="form-error"><?php echo $errarr['evalsubrule_cond2_error']; ?></span>
                            </div>
                            <div class="col-sm-4 ">
                                ...
                                <span id="rate_revision_formula2_error" class="form-error"><?php echo $errarr['rate_revision_formula2_error']; ?></span>
                            </div> 
                            <div class="col-sm-4">
                                ...
                                <span id="evalsubrule_formula2_error" class="form-error"><?php echo $errarr['evalsubrule_formula2_error']; ?></span>
                            </div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <div class="col-sm-4">
                                ...
                                <span id="evalsubrule_cond3_error" class="form-error"><?php echo $errarr['evalsubrule_cond3_error']; ?></span>
                            </div>
                            <div class="col-sm-4 ">
                                ...
                                <span id="rate_revision_formula3_error" class="form-error"><?php echo $errarr['rate_revision_formula3_error']; ?></span>
                            </div>
                            <div class="col-sm-4">
                                ...
                                <span id="evalsubrule_formula3_error" class="form-error"><?php echo $errarr['evalsubrule_formula3_error']; ?></span>
                            </div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <div class="col-sm-4">
                                ...
                                <span id="evalsubrule_cond4_error" class="form-error"><?php echo $errarr['evalsubrule_cond4_error']; ?></span>
                            </div>
                            <div class="col-sm-4 ">
                                ...
                                <span id="rate_revision_formula4_error" class="form-error"><?php echo $errarr['rate_revision_formula4_error']; ?></span>
                            </div>
                            <div class="col-sm-4">
                                ...
                                <span id="evalsubrule_formula4_error" class="form-error"><?php echo $errarr['evalsubrule_formula4_error']; ?></span>
                            </div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            <div class="col-sm-4">
                                ...
                                <span id="evalsubrule_cond5_error" class="form-error"><?php echo $errarr['evalsubrule_cond5_error']; ?></span>
                            </div>
                            <div class="col-sm-4 ">
                                ...
                                <span id="rate_revision_formula5_error" class="form-error"><?php echo $errarr['rate_revision_formula5_error']; ?></span>
                            </div>
                            <div class="col-sm-4">
                                ...
                                <span id="evalsubrule_formula5_error" class="form-error"><?php echo $errarr['evalsubrule_formula5_error']; ?></span>
                            </div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                ...
                                <span id="alternate_formula_error" class="form-error"><?php echo $errarr['alternate_formula_error']; ?></span>
                            </div>
                                    ...
                                    <tr id = "<?php echo $slist['subrule_id']; ?>" >
                                        ...
                                        <td class = 'center width10 tblbigdata'> <?php
                                            echo $this->Form->button('<span class="glyphicon glyphicon-pencil"></span>', array('class' => "editSubrule", 'title' => "Edit", 'id' => $slist['subrule_id'], 'onclick' => "javascript: return editSubrule('"
                                                ...
                                                . "','" . $slist['rate_revision_formula1'] . "','" . $slist['rate_revision_formula2'] . "','" . $slist['rate_revision_formula3'] . "','" . $slist['rate_revision_formula4'] . "','" . $slist['rate_revision_formula5'] . "');"));
                                            ?>
