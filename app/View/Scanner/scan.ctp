...
echo $this->Html->script('scanner.js');
//echo $this->Html->script('pdfobject.js');
echo $this->Html->script('filereader.js');
echo $this->Html->script('qrcodelib.js');
echo $this->Html->script('WebCodeCam.js');
...
?>
    ...
    function scanToJpg() {
        ...
        if (docid != "" && nopages != "") {
            $.post('<?php echo $this->webroot; ?>Scanner/checkscan', {path: path, docid: docid}, function (data)
            {
                if (data == 1) {
...
//                             "use_asprise_dialog": false,
                            ...
                            "output_settings": [
                                ...
                                },
                                {
                                    ...
                                    "upload_target": {
                                        "url": "http://<?php echo $_SERVER['HTTP_HOST']; ?>/NGDRS/Scanner/upload",
                                        "post_fields": {
                                            "docid": docid,
                                            "saveflag": saveflag,
                                            "nopages" : nopages
...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-primary">
            <div class="panel-heading" style="text-align: center"><b><?php echo __('lblscanner'); ?></b></div>
                    ...
                    <div id="div1">
                        <div class="box box-primary"><br><br>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="col-sm-4"></div>
                                    <label for="nopages" class="col-sm-2 control-label center"><?php echo __('lblnoofpages'); ?> :-<span style="color: #ff0000">*</span></label>    
                                    <div class="col-sm-2 center"><?php echo $this->Form->input('nopages', array('label' => false, 'id' => 'nopages', 'style' => 'text-align: left; color: red; font-weight: bold; font-size: larger', 'class' => 'form-control input-sm sample', 'type' => 'text')) ?></div>
                                </div>
                            </div><br>
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group"><br>
                                        <div class="row">
                                            <center><button type="button" onclick="scanToJpg();"><?php echo __('lblscan'); ?></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <button type="button"  onclick="done();"><?php echo __('lbldone'); ?></button>
                                            </center><br><br>
                                        ...
                                        <div class="row">
                                            ...
                                            <?php if (isset($filename)) { ?>
                                                <div class="PDF col-sm-10 col-sm-offset-1" id="pdf">
                                                    <object data="<?php echo $this->webroot; ?>Scanner/loadfile/<?php echo $filename; ?>" type="application/pdf" width="100%" height="500px">
