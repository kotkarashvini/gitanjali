    ...
    format: "dd-mm-yyyy",
            ...
            //    });
                    ...
                    $('#filter2').val('Y');
                            ...
                            document.getElementById("districtwise").submit();
                    }
</script>
<style type="text/css">
    #chart text {
...
<?php echo $this->Form->create('districtwise', array('id' => 'districtwise', 'autocomplete' => 'off')); ?>
<div class="row">
    <div class="col-lg-12">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="btn-arrow">
                <a href="<?php echo $this->webroot; ?>Graph/reg_doc_registered" class="btn bg-maroon  btn-arrow-right">
                    <?php echo 'Registered documents'; ?>
                </a>            
                <a href="<?php echo $this->webroot; ?>Graph/reg_doc_submitted/" class="btn btn-success btn-arrow-right">
                    <?php echo 'Submitted documents'; ?>
                </a>            
                <a href="<?php echo $this->webroot; ?>Graph/reg_doc_fee_calculation/" class="btn btn-success btn-arrow-right">
                    <?php echo 'Account Head wise Collection'; ?>
                </a>            
                <a href="<?php echo $this->webroot; ?>Graph/districtwise/" class="btn btn-success btn-arrow-right">
                    <?php echo 'District wise Collection'; ?>
                </a>            
            </div>
        </div>
    </div>
        ...
        <div class="box-body">
            <div class="row" id="divDate">
                <div class="form-group">
                    ...
                    <label for="Select Date" class="control-label col-sm-2"> <?php echo 'Select Date'; ?> </label>            
