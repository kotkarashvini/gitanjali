...
<?php echo $this->Form->create('acccollection', array('id' => 'acccollection', 'autocomplete' => 'off')); ?>
<div class="row">
    <div class="col-lg-12">
        <div class="box box-primary">

            <div class="box-header with-border">
                <center><h3 class="box-title headbolder"><?php echo 'Account Head wise Collection(Collection in Lakhs)'; ?></h3></center>
            </div>
    ...
    ?>
        {
            ...
            Total: <?php echo round($data1['pay_income']); ?>,
        },
         <?php } ?>
    ];
    chartOptions = [{
