...
<script type="text/javascript">
    ...
    format: "dd-mm-yyyy",
            ...
            document.getElementById("actiontype").value = '1';
                    document.getElementById("reg_doc_submitted").submit();
            }
...
<?php echo $this->Form->create('reg_doc_submitted', array('id' => 'reg_doc_submitted', 'autocomplete' => 'off')); ?>
<div class="row">
    <div class="col-lg-12">
    ...
    <div class="col-md-12">
        <div class="btn-arrow">
            <a href="<?php echo $this->webroot; ?>Graph/reg_doc_registered" class="btn bg-maroon  btn-arrow-right"><?php echo 'Registered documents'; ?></a>            
                ...
                <a href="<?php echo $this->webroot; ?>Graph/reg_doc_fee_calculation/" class="btn btn-success btn-arrow-right"><?php echo 'Fee Collection'; ?></a>            
  ...
  <div class="col-sm-6">
    ...
    <div class="box-header with-border">
                <center><h3 class="box-title headbolder"><?php echo 'Registered Document Submitted Graph'; ?></h3></center>
            </div>
   <div class = "box box-primary">
        <div class="box-body">
