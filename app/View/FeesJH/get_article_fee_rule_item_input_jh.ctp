                        ...
                        <?php } else {
                            ...
                            <?php } else { ?>
                              ...
                              <?php } ?>      
                                ...
                                <div class = 'col-sm-3'>
                                    ...
                                    echo $this->Form->input($feeItem['fee_param_code'], array('label' => FALSE, 'type' => $type, 'id' => $feeItem['fee_param_code'], 'value' => (($val['value']['articledepfield_value']) ? $val['value']['articledepfield_value'] : $val['value']['articledepfield_value']), 'maxlength' => 15)); 
                            ...
                            <?php } else { ?> 
                                ...
                                <div class = 'col-sm-3'>
                                    ...
                                    } else if ($feeItem['fee_param_code'] == 'FDA') {
                                        if (isset($gender_value)) {
                                            echo $this->Form->input($feeItem['fee_param_code'], array('label' => FALSE, 'type' => $type, 'id' => $feeItem['fee_param_code'], 'value' => (($gender_value) ? $gender_value : 0), 'maxlength' => 15, 'readonly' => 'readonly'));
                                        }
                                    } else {
                                        echo $this->Form->input($feeItem['fee_param_code'], array('label' => FALSE, 'type' => $type, 'id' => $feeItem['fee_param_code'], 'value' => (($val['value']['articledepfield_value']) ? $val['value']['articledepfield_value'] : 0), 'maxlength' => 15));
                                    }
