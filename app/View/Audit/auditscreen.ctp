...
<script>
    $(document).ready(function () {
        $('#table_id').change(function () {
            ...
            $.post('<?php echo $this->webroot; ?>Audit/get_column', {table_id: table_id, token: 'N', csrftoken: csrftoken}, function (data)
            {
...
<?php
echo $this->Form->create('auditscreen', array('id' => 'auditscreen', 'class' => 'form-vertical'));
?>
    ...
    <div class="col-lg-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <center><h3 class="box-title headbolder"><?php echo __('lblalltblaudit'); ?></h3></center>
            </div>
            <div class="box-body">
                <div class="row">
