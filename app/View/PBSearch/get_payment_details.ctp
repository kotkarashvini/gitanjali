...
if (isset($paymentfields) && !empty($paymentfields)) {
    ?>
    <?php echo $this->Form->create('payment', array('url' => array('controller' => 'PBSearch', 'action' => 'payment_verification')), array('id' => 'payment', 'class' => 'form-vertical')); ?>   
...
<div class="form-group">
    <label> <?php echo $field['field_name_desc_' . $lang] ?> <span class="star" ><?php echo $field['required_mark']; ?></span></label>
        ...
        if ($field['field_name'] == 'account_head_code') {
            ...
            $drop_option= $this->requestAction(array('controller' => 'PBSearch', 'action' => 'get_payment_field_values',$field['field_id'] ));  
    ...
    <div class="col-lg-12">
        <div class="form-group">
            ...
            <button id="btncancel" name="btncancel" class="btn btn-info " type="reset">
                ...
                <?php echo $this->Html->link('New Entry', array('controller' => 'PBSearch', 'action' => 'payment_verification'), array('class' => 'btn btn-danger', 'escape' => false));
                ?>
        </div>
    </div>
</div>       
