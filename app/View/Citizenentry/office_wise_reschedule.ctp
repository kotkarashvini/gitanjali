...
<div class="row">
    <div class="col-lg-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <center><h3 class="box-title headbolder"><?php echo __('Office Wise Reschedule Appointment') ?></h3></center>
 ...
 <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                    <?php echo $this->Form->input('office_id', array('type' => 'select', 'label' => false, 'id' => 'office_id', 'class' => 'form-control input-sm', 'options' => $office,'empty'=>'--------Select------')); ?>
                        </div>
 ...
 <div class="box box-primary" id="divwitness">
            <div class="box-body">
                <table id="tableapp" class="table table-striped table-bordered table-hover">  
                    <thead >  
                        <tr>  
                            <th class="center width10"><?php echo __('Office Name'); ?></th>
                    ...
                    <tbody>
                        <?php if(!empty($reschedule)){foreach($reschedule as $rec){
                            ...
                            ?>
                        <tr>
                               <td><?php echo $rec['o']['office_name_en']; ?></td>
