                            ...
                            <tr>
                                ...
                                <td class="tblbigdata">
                                    ...
                                    echo $this->Html->link('Edit', array('controller' => 'citizenentry', 'action' => 'property_details', $this->Session->read('csrftoken'), $property['property_details_entry']['property_id']), array('confirm' => 'Are you sure you wish to Edit this property?', 'class' => 'btn btn-info')
                                     ...
                                     echo $this->Html->link('Delete', array('controller' => 'Citizenentry', 'action' => 'property_remove', $this->Session->read('csrftoken'), $property['property_details_entry']['property_id']), array('confirm' => 'Please Use Update Option If Possible,Delete Will Delete All Party Related To This Property,Are You Sure You Wish To Delete This Property?', 'class' => 'btn btn-info')
                                    );
                                    ?>
                                </td>
                            </tr>
