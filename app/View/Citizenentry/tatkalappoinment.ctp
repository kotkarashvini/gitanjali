...
<?php if($tatkal_paid =='Y'){?>
                           <div class="box-header with-border">
                    <center style="color: red;"><h3 class="box-title headbolder"><?php echo __('You have paid tatkal appointment fee now select Date and Shift');?></h3></center>
                       
                </div>
<?php } ?>
                         <div class="box-header with-border">
                    <center style="color: red;"><h3 class="box-title headbolder"><?php echo __('After complition of HDFC payment move once again to tatkal appointment page to fix appointment.');?></h3></center>
