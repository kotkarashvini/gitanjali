...
<div class="login-box" id="divhintdetails" hidden="true">
    ...
    <div class="login-box-body log_border">
        <p class="login-box-msg"><?php echo __('lblprovideans'); ?></p>
...
<div class="login-box" id="divotpdetails" hidden="true">
    ...
    <div class="login-box-body log_border">
        ...
        <div class="form-group has-feedback">
            <?php echo $this->Form->input('txtotp', array('label' => false, 'id' => 'txtotp', 'type' => 'text', 'placeholder' => 'Enter OTP', 'class' => 'form-control validate[required],custom[onlyLetterSp]')); ?>
        </div>
