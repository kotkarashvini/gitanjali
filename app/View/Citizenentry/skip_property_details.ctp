...
<?php
echo $this->Form->create('propertyscreennew', array('url' => array('controller' => 'citizenentry', 'action' => 'skip_property_details', $this->Session->read('csrftoken')), 'id' => 'propertyscreennew'));
...
<script>
    $(document).ready(function () {
        $("input[name='data[propertyscreennew][usage_cat_id][]']").prop("disabled", true);
//$("input[name='data[propertyscreennew][usage_cat_id][]']").on("click.readonly", function(event){event.preventDefault();}).css("opacity", "0.5");
        // $("#loader").hide();
...
//        });
        $("#btnSave").click(function () {
            var csrftoken = <?php echo $this->Session->read('csrftoken'); ?>;
            $("#actiontype").val(3);
            $("input[name='data[propertyscreennew][usage_cat_id][]']").prop("disabled", false);
    ...
    function after_validation_check_propertyscreennew(event) {
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <?php echo $this->Form->input('attribute_value', array('label' => false, 'class' => 'form-control', 'type' => 'text',  'id' => 'attribute_value', 'placeholder' => 'Value')); ?>
                        ...
                        <tr>
                            ...
                            <td class="tblbigdata">
                                ...
                                <input type="button" class="btn btn-primary" value="View Valuation" onclick="javascript: return formview('<?php echo base64_encode($property['property_details_entry']['val_id']); ?>');">
                                    ...
                                    ?>
                                    <?php
                                    echo $this->Html->link('Edit', array('controller' => 'citizenentry', 'action' => 'skip_property_details', $this->Session->read('csrftoken'), $property['property_details_entry']['property_id']), array('confirm' => 'Are you sure you wish to Edit this property?', 'class' => 'btn btn-info')
                                    );

                                     echo $this->Html->link('Delete', array('controller' => 'Citizenentry', 'action' => 'skip_property_remove', $this->Session->read('csrftoken'), $property['property_details_entry']['property_id']), array('confirm' => 'Please Use Update Option If Possible,Delete Will Delete All Party Related To This Property,Are You Sure You Wish To Delete This Property?', 'class' => 'btn btn-info')
                                    );
                                    ?>
                            </td>
                        </tr>
