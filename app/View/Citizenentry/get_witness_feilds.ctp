...
<script type="text/javascript">
 ...
 sortSelect('#taluka_id', 'text', 'asc');
        ...
        $("#village_id").on('change', function () {
            $.post('<?php echo $this->webroot; ?>Citizenentry/behavioral_patterns', {village_id: $("#village_id").val(), ref_id: 3, behavioral_id: 2, csrftoken: csrftoken}, function (data)
            {
                ...
                <div class="col-md-12">
                    ...
                    foreach ($witnessfields as $field) {
                        ...
                        if (isset($rec) && !empty($rec)) {
                            $upadteflag = 1;
                            $witness[$field['field_id_name_en']] = $rec[0]['witness'][$field['field_id_name_en']];
                            if ($field['field_id_name_ll']) {
                                $witness[$field['field_id_name_ll']] = $rec[0]['witness'][$field['field_id_name_ll']];
                            }
