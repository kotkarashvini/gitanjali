                        ...
                        <tbody>
                            ...
                            for ($j = 0; $j < count($upload_file1); $j++) {
                                ...
                                <tr>
                                    ...
                                    <td class="tblbigdata"><?php echo $upload_file1[$j]['upload_document']['document_name_en'].' '; ?><span><?php echo "(File Size:".$upload_file1[$j]['upload_document']['file_size']."MB) " ?></span><?php if($upload_file1[$j]['ad']['is_required']=='Y'){?><span style="color: #ff0000">*</span><?php } ?></td>
                                    ...
                                    <td> <?php
                                        if (!empty($upload_fileinfo)) {
                                            foreach ($upload_fileinfo as $upload) {
                                                if ($upload['uploaded_file_trn']['document_id'] == $upload_file1[$j]['upload_document']['document_id']) {
                                                    if ($upload['uploaded_file_trn']['out_fname'] != '') {
                                                        ...
                                                        echo $this->Html->link(
                                                            ...
                                                            'full_base' => true, $upload['uploaded_file_trn']['out_fname'])
                                                        );
                                                    }
                                                }
                                            }
