                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-header with-border">
                                <h3 class="box-title headbolder"><?php echo __('lblappointmentdetails'); ?></h3>
                                 <?php if($reschedule=='Y'){?>
                                <span style="font-weight: bold; color: red;">&nbsp;&nbsp;&nbsp;(First Cancel the Appointment and then take New Appointment)</span>
                                <button type="button" style="width: 150px; float:right;"  name="btnCancel" class="btn btn-info" value="Reschedule Appoinment"  id="cancelapt">
