...
<script type="text/javascript">
 ...
 sortSelect('#taluka_id', 'text', 'asc');
        ...
        $("#village_id").on('change', function () {
            $.post('<?php echo $this->webroot; ?>Citizenentry/behavioral_patterns', {village_id: $("#village_id").val(), ref_id: 5, behavioral_id: 2, csrftoken: csrftoken}, function (data)
            {
                                ...
                                <div class="col-sm-3">
                                    ...
                                    switch ($field['field_id_name_en']) {
                                        ...
                                        case 'is_executer': echo $this->Form->input($field['field_id_name_en'], array('id' => $field['field_id_name_en'], 'class' => 'form-control input-sm chosen-select', 'label' => false, 'options' => $executer, 'default' => $iden[$field['field_id_name_en']]));
                                            ...
                                            <?php
                                            break;
                                         case 'party_id': echo $this->Form->input($field['field_id_name_en'], array('id' => $field['field_id_name_en'], 'class' => 'form-control input-sm chosen-select', 'label' => false, 'options' => $allparty, 'default' => $iden[$field['field_id_name_en']]));
                                            ?>
