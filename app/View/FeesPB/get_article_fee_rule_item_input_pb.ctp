    ...
    <div class = 'col-sm-12'>
        <div class = 'form-group'>
            ...
            <div class = 'col-sm-3'>
                                    ...
                                    <?php echo $this->Form->input($feeItem['fee_param_code'], array('label' => FALSE, 'type' => $type, 'id' => $feeItem['fee_param_code'], 'value' => (($val['value']['articledepfield_value']) ? $val['value']['articledepfield_value'] : 0), 'maxlength' => 15)); ?> 
                <span id="<?php echo $feeItem['fee_param_code']; ?>_error" class="form-error"> </span>
            </div>
            ...
            <div class = 'col-sm-2'><label for = '<?php echo $feeItem['fee_param_code']; ?>' > <?php echo $feeItem['fee_item_desc_' . $lang]; ?> </label></div>
            <div class = 'col-sm-3'>
                    <?php if ($feeItem['fee_param_code'] == 'FAA') {
                                echo $this->Form->input($feeItem['fee_param_code'], array('label' => FALSE, 'id' => $feeItem['fee_param_code'], 'value' => (($val['value']['articledepfield_value']) ? $val['value']['articledepfield_value'] : 0), 'maxlength' => 15,'readonly'=>'readonly')); 
                                   }else if ($feeItem['fee_param_code'] == 'FDG') {
                                      echo $this->Form->input($feeItem['fee_param_code'], array('label' => FALSE, 'id' => $feeItem['fee_param_code'], 'maxlength' => 15)); 
                                   }else{
                                       echo $this->Form->input($feeItem['fee_param_code'], array('label' => FALSE, 'id' => $feeItem['fee_param_code'], 'value' => (($val['value']['articledepfield_value']) ? $val['value']['articledepfield_value'] : 0), 'maxlength' => 15)); 
                                   }
                                ?> 
                <span id="<?php echo $feeItem['fee_param_code']; ?>_error" class="form-error"> </span>
            </div>
    ...
    <div class = 'col-sm-12'>
        <div class = 'form-group'>
            ...
            <div class = 'col-sm-3' style = 'background-color:#aab2b2;'>
                                   ...
                                   <?php echo $this->Form->input($feeItem['fee_param_code'], array('type' => 'select', 'id' => $feeItem['fee_param_code'], 'disabled', 'style' => 'cursor: not-allowed;', 'label' => FALSE, 'value' => (($val['value']['articledepfield_value']) ? $val['value']['articledepfield_value'] : NULL), 'options' => (($items_list[$feeItem['fee_param_code']]) ? $items_list[$feeItem['fee_param_code']] : NULL)));
