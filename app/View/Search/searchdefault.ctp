...
//                $('#party_type_id').val('');
        ...
        $('#article_id').change(function () {
            ...
            $.getJSON('<?php echo $this->webroot; ?>Search/get_party_type', {article_id: article_id}, function (data)
            {
        ...
        $('#taluka_id').change(function () {
            ...
            $.getJSON('<?php echo $this->webroot; ?>Search/get_village', {taluka_id: taluka_id}, function (data)
            {
                var sc = '<option value="">--Select--</option>';
                $.each(data, function (index, val) {
                    sc += "<option value=" + index + ">" + val + "</option>";
    ...
    function nonemcomb_copy(token_no) {
        ...
        var to = $('#hftoyear').val();
        $.post('<?php echo $this->webroot; ?>Search/rptnonemcomb_copy', {token_no: token_no, from: from, to: to}, function (data)
        {
            $("#rptdetails").html('');
            $("#downdeed").html('');
             $('#btnpay').hide();
...
//             $('#myModal').modal('show');
    ...
    function details(token_no,flag) {
        var from = $('#hffromyear').val();
        var to = $('#hftoyear').val();
        $.post('<?php echo $this->webroot; ?>Search/rptdetails', {token_no: token_no, from: from, to: to, flag: flag}, function (data)
        {
            $("#rptdetails").html('');
            $("#downdeed").html('');
             $('#btnpay').hide();
...
//             $('#myModal').modal('show');
    ...
    function Certifiedcopy(token_no) {
        $.post('<?php echo $this->webroot; ?>Search/fee_receipt', {token_no: token_no}, function (data)
        {
                                    ...
                                    <td class="width10 center">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                ...
                                                <li class="divider"></li>
                                                <li> <?php
                                                    $scan_upload = $this->requestAction(array('controller' => 'Search', 'action' => 'getscandata', $partygrid1[0]['token_no']));
...
<div class="row" id="divbyproperty">
    <div class="col-lg-12">
                                    ...
                                    <td class="width10 center">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                ...
                                                <li class="divider"></li>
                                                <li> <?php
                                                    $scan_upload = $this->requestAction(array('controller' => 'Search', 'action' => 'getscandata', $propertygrid1[0]['token_no']));
                                                    if (!empty($scan_upload)) {
                                                        echo $this->Html->link(
                                                                __('Inspection Copy'), array(
                                                            'disabled' => TRUE,
        ...
        <?php } ?> </li>
                                    ...
                                    <td >  <?php
                                        $result = $this->requestAction(array('controller' => 'Search', 'action' => 'propertydata', $propertygrid1[0]['token_no']));
                                        echo $result;
                                        ?> </td>
...
<?php // echo $this->Form->input('article_id2', array('options' => array($article), 'empty' => '--select--', 'id' => 'article_id2', 'label' => false, 'class' => 'form-control input-sm'));     ?>
    ...
    <?php foreach ($deedgrid as $deedgrid1): ?>
                                    ...
                                    <td class="width10 center">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                ...
                                                <li class="divider"></li>
                                                <li> <?php
                                                    $scan_upload = $this->requestAction(array('controller' => 'Search', 'action' => 'getscandata', $deedgrid1[0]['token_no']));
                                                    if (!empty($scan_upload)) {
                                                        echo $this->Html->link(
                                                                __('Inspection Copy'), array(
                                                            'disabled' => TRUE,
        ...
        <?php } ?> </li>
                                    ...
                                    <td >  <?php
                                        $result = $this->requestAction(array('controller' => 'Search', 'action' => 'propertydata', $deedgrid1[0]['token_no']));
                                        echo $result;
                                        ?> </td>
