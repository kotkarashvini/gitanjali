 ...
 */
    ...
    'autoRegenerate' => true,
    'handler' => array(
        'model' => 'database_sessions'
    ),
    'ini' => array(
        'session.gc_divisor' => 1000,
        'session.cookie_secure' => false,//for the ssl certificate :true else false
 ...
 */
	Configure::write('Security.salt', 'DYhG93b0qyJfIxmdhcnfysakdWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76859309657464851237959683645');
...
//Configure::write('Cache.disable', true);     //Every time Cache disable
