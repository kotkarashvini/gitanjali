...
//-----------------------------------Shridhar-----------------------------------    
    public function get_party_entry($lang = NULL, $doc_token_no = NULL, $property_id = NULL) {
        ...
        return $this->find('all', array('fields' => array('party_catg.authorised_signatory','saluation.salutation_desc_' . $lang, 
            'occupation.occupation_name_' . $lang, 'gender.gender_desc_' . $lang, 'party_type.party_type_flag', 'party_type.party_type_desc_' . $lang, 
            'party_catg.category_name_en', 'village.village_name_' . $lang, 'taluka.taluka_name_' . $lang, 'district.district_name_' . $lang, 
            'party_entry.*'),
