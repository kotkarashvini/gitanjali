...
class loc_level_1_prop_list extends AppModel {
    //put your code here
    public $useDbConfig = 'ngprs';
    public $useTable = 'ngdrstab_mst_loc_level_1_prop_list';
     public $primaryKey = 'prop_level1_list_id';
     
     public function get_duplicate($languagelist) {
        $duplicate['Table'] = 'ngdrstab_mst_loc_level_1_prop_list';
        $duplicate['PrimaryKey'] = 'prop_level1_list_id';
        $fields = array();
        foreach ($languagelist as $language) {
            array_push($fields, 'list_1_desc_' . $language['mainlanguage']['language_code']);
        }
...
//        $fieldlist['corp_id']['select'] = 'is_select_req';
        ...
        foreach ($languagelist as $language) {
            if ($language['mainlanguage']['language_code'] == 'en') {
                $fieldlist['list_1_desc_' . $language['mainlanguage']['language_code']]['text'] = 'is_required,is_alphanumericspace';
            } else {
                $fieldlist['list_1_desc_' . $language['mainlanguage']['language_code']]['text'] = 'unicoderequired_rule_' . $language['mainlanguage']['language_code'];
            }
        }
