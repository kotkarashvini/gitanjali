    ...
    public function fieldlist($languagelist) {
        ...
        foreach ($languagelist as $language) {
            if ($language['mainlanguage']['language_code'] == 'en') {
                $fieldlist['execution_type_' . $language['mainlanguage']['language_code']]['text'] = 'is_required,is_alphanumericspace';
            } else {
                $fieldlist['execution_type_' . $language['mainlanguage']['language_code']]['text'] = '';
            }
