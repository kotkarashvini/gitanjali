...
class fillDropdown extends AppModel {
                ...
                //pr($arrparam);
                  $result = ClassRegistry::init('UnitMapping')->find('list', array(
                            ...
                            'conditions' => array(
                                'UnitMapping.usage_main_catg_id' => $usage['usagelnk']['usage_main_catg_id'],
                                'UnitMapping.usage_sub_catg_id' => $usage['usagelnk']['usage_sub_catg_id'],
                                'UnitMapping.usage_param_id' => $arrparam['usage_param_id'],
                            ), 'order' => 'sr_no ASC'
                                )
                        );
            }
    ...
    //kalyani call fromrulechangeevent.ctp
    public function getlistitem($uasge_param_id, $lang) {
      //   pr($uasge_param_id);
            $proceduretype = ClassRegistry::init('configlistitems')->find('list', array('fields' => array('item_desc_id', 'item_desc_' . $lang),'conditions' => array('item_id' => $uasge_param_id), 'order' => array('display_order' => 'ASC')));
//      pr($proceduretype);
