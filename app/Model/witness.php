...
class witness extends AppModel {

    //put your code here.
    public $useDbConfig = 'ngprs';
    public $useTable = 'ngdrstab_trn_witness';
    
//    var $virtualFields = array(
//    'name' => "CONCAT(Level1.level_1_from_range, '-', Level1.level_1_to_range)"
//);
function get_allwitness($language,$tokenval,$user_id)
{
    $witness=$this->query("select a.*,b.salutation_desc_" . $language . "  as salutaion_desc
                                                        from ngdrstab_trn_witness a
...
{
   return  $this->find('all', array('fields' => array('saluation.salutation_desc_' . $lang, 'occupation.occupation_name_'.$lang, 'gender.gender_desc_'.$lang, 'witness_type.witness_type_desc_' . $lang, 'village.village_name_' . $lang, 'taluka.taluka_name_' . $lang, 'district.district_name_' . $lang, 'witness.*'),
