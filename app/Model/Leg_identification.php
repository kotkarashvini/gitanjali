...
class Leg_identification extends AppModel {

    //put your code here.
    public $useDbConfig = 'ngprs';
    public $useTable = 'ngdrstab_trn_legacy_identification';
...
//);
    ...
    function get_identification_details($language, $tokenval) {
               ...
               identifier.desc_en
                from ngdrstab_trn_legacy_identification a
                ...
                left outer join ngdrstab_mst_identifier_type identifier on identifier.type_id=a.identifier_type_id 
                where a.token_no= ? ", array($tokenval));
    }

    //--------------------------------------------------- Modified on  22-March-2017--------------------------------------------------------------
    function get_identification($lang, $doc_token_no, $report_type = NULL) {

      //  $options['token_no'] = $doc_token_no;
        
       /* if ($report_type == 'P') {
           // $options['biometric_upload is not null'];
           // $options['photo_upload'] =      date('Y-m-d');
        }*/
        
        return $this->find('all', array('fields' => array('saluation.salutation_desc_' . $lang, 'occupation.occupation_name_' . $lang, 'gender.gender_desc_' . $lang, 'party_type.party_type_desc_' . $lang, 'identy.identificationtype_desc_'.$lang, 'state.state_name_' . $lang, 'village.village_name_' . $lang, 'taluka.taluka_name_' . $lang, 'district.district_name_' . $lang, 'Leg_identification.*'),
                    'conditions' => array('token_no' => $doc_token_no),
                    'joins' => array(
                        array('table' => 'ngdrstab_mst_salutation', 'type' => 'left', 'alias' => 'saluation', 'conditions' => array('saluation.salutation_id=Leg_identification.salutation')),
                        array('table' => 'ngdrstab_mst_gender','type' => 'left',  'alias' => 'gender', 'conditions' => array('gender.gender_id=Leg_identification.gender_id')),
                        array('table' => 'ngdrstab_mst_occupation', 'type' => 'left', 'alias' => 'occupation', 'conditions' => array('occupation.occupation_id=Leg_identification.occupation_id')),
                        array('table' => 'ngdrstab_mst_party_type', 'type' => 'left', 'alias' => 'party_type', 'conditions' => array('party_type.party_type_id=Leg_identification.party_type_id')),
                        array('table' => 'ngdrstab_mst_identificationtype', 'type' => 'left', 'alias' => 'identy', 'conditions' => array('identy.identificationtype_id=Leg_identification.identificationtype_id')),
                        array('table' => 'ngdrstab_conf_admblock1_state', 'type' => 'left', 'alias' => 'state', 'conditions' => array('state.state_id=Leg_identification.state_id')),
                        array('table' => 'ngdrstab_conf_admblock7_village_mapping', 'type' => 'left', 'alias' => 'village', 'conditions' => array('village.village_id=Leg_identification.village_id')),
                        array('table' => 'ngdrstab_conf_admblock3_district', 'type' => 'left', 'alias' => 'district', 'conditions' => array('district.district_id=Leg_identification.district_id')),
                        array('table' => 'ngdrstab_conf_admblock5_taluka', 'type' => 'left', 'alias' => 'taluka', 'conditions' => array('taluka.taluka_id=Leg_identification.taluka_id'))
        )));
    }
    
    function get_identification_geninfo($lang, $doc_token_no, $report_type = NULL) {
       ...
       $options['token_no'] = $doc_token_no;
        ...
        return $this->find('all', array('fields' => array('saluation.salutation_desc_' . $lang, 'occupation.occupation_name_' . $lang, 'gender.gender_desc_' . $lang, 'party_type.party_type_desc_' . $lang, 'identification_type.desc_' . $lang, 'state.state_name_' . $lang, 'village.village_name_' . $lang, 'taluka.taluka_name_' . $lang, 'district.district_name_' . $lang, 'identification.*'),
                    'conditions' => $options,
                    'joins' => array(
                        array('table' => 'ngdrstab_mst_salutation', 'type' => 'left', 'alias' => 'saluation', 'conditions' => array('saluation.salutation_id=identification.salutation')),
                        array('table' => 'ngdrstab_mst_gender','type' => 'left',  'alias' => 'gender', 'conditions' => array('gender.gender_id=identification.gender_id')),
