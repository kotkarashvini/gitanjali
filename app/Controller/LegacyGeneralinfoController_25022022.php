    ...
    public function information() {
        ...
        // $fieldlist['book_serial_number']['text'] = 'is_required,is_alphanumeric';
            ...
            $fieldlist['district_id']['select'] = 'is_required,is_select_req';
                 ...
                 $fieldlist['doc_entered_district_id']['select'] = 'is_required,is_select_req';
            $fieldlist['doc_entered_subdivision_id']['select'] = 'is_required,is_select_req';
            $fieldlist['doc_entered_office_id']['select'] = 'is_required,is_select_req';
...
// $subdivision = $this->Subdivision->find('list', array('fields' => array('subdivision_id', 'subdivision_name_en'), 'conditions' => array('district_id' => $doc_entered_district)));
// //$this->set('doc_entered_subdivision', $doc_entered_subdivision);
// //$doc_entered_subdivision = $this->District->find('list', array('fields' => array('district_id', 'district_name_en'), 'order' => array('district_name_en' => 'ASC')));
// $this->set('doc_entered_subdivision', $subdivision);
            ...
            if ($this->request->is('post') || $this->request->is('put')) {
                ...
                if (!empty($Selectedtoken)) {
                    ...
                    $this->request->data['General_infoctp']['presentation_no'] = $demodata[0][0]['presentation_no'];
