 ...
 * @author nic
 */
class PBSearchController extends AppController {
                ...
                if ($frmdate <= $todate && $todate >= $new_date && $frmdate >= $new_date) {
                    ...
                    if ($this->validationError($errarr)) {
                        if ($this->Searcher->save($this->request->data['searchindex'])) {
                            ...
                            $this->redirect(array('controller' => 'PBSearch', 'action' => 'searchdefault', $district_id, $frmdate, $todate));
...
//            }
            ...
            $downloaddeed = "";
            if ($searcherdata['payment_status'] == 'Y') {
                $downloaddeed .= "<a href='" . $this->webroot . "PBSearch/downloadfile/" . $scan_upload['scan_upload']['scan_name'] . "/Scanning/" . $_POST['token_no'] . "/C' class='btn btn-primary'>Download Deed</a>";
            } else {
                ...
                $downloaddeed .= "<a href='" . $this->webroot . "PBSearch/payment_verification' target='_blank' class='btn btn-primary'>Verify Payment</a>";
            }
